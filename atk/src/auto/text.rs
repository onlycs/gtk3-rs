...
use crate::{ffi,CoordType,TextBoundary,TextClipType,TextGranularity,TextRange,TextRectangle};
#[cfg(feature = "v2_32")]
...
pub trait TextExt: IsA<Text> + 'static {
    ...
    fn bounded_ranges(&self, rect: &mut TextRectangle, coord_type: CoordType, x_clip_type: TextClipType, y_clip_type: TextClipType) -> Vec<TextRange> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(ffi::atk_text_get_bounded_ranges(self.as_ref().to_glib_none().0, rect.to_glib_none_mut().0, coord_type.into_glib(), x_clip_type.into_glib(), y_clip_type.into_glib()))
        }
    }
    ...
    fn character_at_offset(&self, offset: i32) -> char {
        unsafe {
            std::convert::TryFrom::try_from(ffi::atk_text_get_character_at_offset(self.as_ref().to_glib_none().0, offset)).expect("conversion from an invalid Unicode value attempted")
        }
    }
    ...
    fn character_extents(&self, offset: i32, coords: CoordType) -> (i32, i32, i32, i32) {
        unsafe {
            ...
            ffi::atk_text_get_character_extents(self.as_ref().to_glib_none().0, offset, x.as_mut_ptr(), y.as_mut_ptr(), width.as_mut_ptr(), height.as_mut_ptr(), coords.into_glib());
    ...
    fn offset_at_point(&self, x: i32, y: i32, coords: CoordType) -> i32 {
        unsafe {
            ffi::atk_text_get_offset_at_point(self.as_ref().to_glib_none().0, x, y, coords.into_glib())
        }
    }

    #[doc(alias = "atk_text_get_range_extents")]
    #[doc(alias = "get_range_extents")]
    fn range_extents(&self, start_offset: i32, end_offset: i32, coord_type: CoordType) -> TextRectangle {
        unsafe {
            let mut rect = TextRectangle::uninitialized();
            ffi::atk_text_get_range_extents(self.as_ref().to_glib_none().0, start_offset, end_offset, coord_type.into_glib(), rect.to_glib_none_mut().0);
            rect
        }
    }
    ...
    fn selection(&self, selection_num: i32) -> (glib::GString, i32, i32) {
        unsafe {
            ...
            let ret = from_glib_full(ffi::atk_text_get_selection(self.as_ref().to_glib_none().0, selection_num, start_offset.as_mut_ptr(), end_offset.as_mut_ptr()));
    ...
    fn string_at_offset(&self, offset: i32, granularity: TextGranularity) -> (Option<glib::GString>, i32, i32) {
        unsafe {
            let mut start_offset = std::mem::MaybeUninit::uninit();
            let mut end_offset = std::mem::MaybeUninit::uninit();
            let ret = from_glib_full(ffi::atk_text_get_string_at_offset(self.as_ref().to_glib_none().0, offset, granularity.into_glib(), start_offset.as_mut_ptr(), end_offset.as_mut_ptr()));
            (ret, start_offset.assume_init(), end_offset.assume_init())
        }
    }
    ...
    fn text_at_offset(&self, offset: i32, boundary_type: TextBoundary) -> (glib::GString, i32, i32) {
        unsafe {
            let mut start_offset = std::mem::MaybeUninit::uninit();
            let mut end_offset = std::mem::MaybeUninit::uninit();
            let ret = from_glib_full(ffi::atk_text_get_text_at_offset(self.as_ref().to_glib_none().0, offset, boundary_type.into_glib(), start_offset.as_mut_ptr(), end_offset.as_mut_ptr()));
            (ret, start_offset.assume_init(), end_offset.assume_init())
        }
    }
    ...
    fn scroll_substring_to(&self, start_offset: i32, end_offset: i32, type_: ScrollType) -> bool {
        unsafe {
            from_glib(ffi::atk_text_scroll_substring_to(self.as_ref().to_glib_none().0, start_offset, end_offset, type_.into_glib()))
        }
    }
    ...
    fn scroll_substring_to_point(&self, start_offset: i32, end_offset: i32, coords: CoordType, x: i32, y: i32) -> bool {
        unsafe {
            from_glib(ffi::atk_text_scroll_substring_to_point(self.as_ref().to_glib_none().0, start_offset, end_offset, coords.into_glib(), x, y))
        }
    }
    ...
    fn connect_text_attributes_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn text_attributes_changed_trampoline<P: IsA<Text>, F: Fn(&P) + 'static>(this: *mut ffi::AtkText, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"text-attributes-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(text_attributes_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "text-caret-moved")]
    fn connect_text_caret_moved<F: Fn(&Self, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn text_caret_moved_trampoline<P: IsA<Text>, F: Fn(&P, i32) + 'static>(this: *mut ffi::AtkText, arg1: std::ffi::c_int, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"text-caret-moved\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(text_caret_moved_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "text-insert")]
    fn connect_text_insert<F: Fn(&Self, i32, i32, &str) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn text_insert_trampoline<P: IsA<Text>, F: Fn(&P, i32, i32, &str) + 'static>(this: *mut ffi::AtkText, arg1: std::ffi::c_int, arg2: std::ffi::c_int, arg3: *mut std::ffi::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Text::from_glib_borrow(this).unsafe_cast_ref(), arg1, arg2, &glib::GString::from_glib_borrow(arg3))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("text-insert::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"text-insert\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(text_insert_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "text-remove")]
    fn connect_text_remove<F: Fn(&Self, i32, i32, &str) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn text_remove_trampoline<P: IsA<Text>, F: Fn(&P, i32, i32, &str) + 'static>(this: *mut ffi::AtkText, arg1: std::ffi::c_int, arg2: std::ffi::c_int, arg3: *mut std::ffi::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Text::from_glib_borrow(this).unsafe_cast_ref(), arg1, arg2, &glib::GString::from_glib_borrow(arg3))
        }
        unsafe {
            ...
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"text-remove\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(text_remove_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "text-selection-changed")]
    fn connect_text_selection_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn text_selection_changed_trampoline<P: IsA<Text>, F: Fn(&P) + 'static>(this: *mut ffi::AtkText, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Text::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"text-selection-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(text_selection_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
