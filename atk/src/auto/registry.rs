...
pub trait RegistryExt: IsA<Registry> + 'static {
    ...
    fn factory(&self, type_: glib::types::Type) -> Option<ObjectFactory> {
        unsafe {
            from_glib_none(ffi::atk_registry_get_factory(self.as_ref().to_glib_none().0, type_.into_glib()))
        }
    }
    ...
    fn factory_type(&self, type_: glib::types::Type) -> glib::types::Type {
        unsafe {
            from_glib(ffi::atk_registry_get_factory_type(self.as_ref().to_glib_none().0, type_.into_glib()))
        }
    }
    ...
    fn set_factory_type(&self, type_: glib::types::Type, factory_type: glib::types::Type) {
        unsafe {
            ffi::atk_registry_set_factory_type(self.as_ref().to_glib_none().0, type_.into_glib(), factory_type.into_glib());
        }
    }
}
