...
pub trait TableCellExt: IsA<TableCell> + 'static {
    ...
    fn column_header_cells(&self) -> Vec<Object> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(ffi::atk_table_cell_get_column_header_cells(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn position(&self) -> Option<(i32, i32)> {
        unsafe {
            ...
            let ret = from_glib(ffi::atk_table_cell_get_position(self.as_ref().to_glib_none().0, row.as_mut_ptr(), column.as_mut_ptr()));
            if ret { Some((row.assume_init(), column.assume_init())) } else { None }
        }
    }
    ...
    fn row_column_span(&self) -> Option<(i32, i32, i32, i32)> {
        unsafe {
            ...
            let ret = from_glib(ffi::atk_table_cell_get_row_column_span(self.as_ref().to_glib_none().0, row.as_mut_ptr(), column.as_mut_ptr(), row_span.as_mut_ptr(), column_span.as_mut_ptr()));
            if ret { Some((row.assume_init(), column.assume_init(), row_span.assume_init(), column_span.assume_init())) } else { None }
        }
    }
    ...
    fn row_header_cells(&self) -> Vec<Object> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(ffi::atk_table_cell_get_row_header_cells(self.as_ref().to_glib_none().0))
        }
    }
