...
pub trait AtkImageExt: IsA<Image> + 'static {
    ...
    fn image_position(&self, coord_type: CoordType) -> (i32, i32) {
        unsafe {
            ...
            ffi::atk_image_get_image_position(self.as_ref().to_glib_none().0, x.as_mut_ptr(), y.as_mut_ptr(), coord_type.into_glib());
    ...
    fn image_size(&self) -> (i32, i32) {
        unsafe {
            ...
            ffi::atk_image_get_image_size(self.as_ref().to_glib_none().0, width.as_mut_ptr(), height.as_mut_ptr());
