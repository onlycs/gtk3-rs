...
pub trait AtkObjectExt: IsA<Object> + 'static {
    ...
    fn add_relationship(&self, relationship: RelationType, target: &impl IsA<Object>) -> bool {
        unsafe {
            from_glib(ffi::atk_object_add_relationship(self.as_ref().to_glib_none().0, relationship.into_glib(), target.as_ref().to_glib_none().0))
        }
    }
    ...
    fn accessible_id(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::atk_object_get_accessible_id(self.as_ref().to_glib_none().0))
        }
    }
...
#[must_use]
    ...
    fn notify_state_change(&self, state: State, value: bool) {
        unsafe {
            ffi::atk_object_notify_state_change(self.as_ref().to_glib_none().0, state, value.into_glib());
        }
    }
...
#[must_use]
    ...
    fn remove_relationship(&self, relationship: RelationType, target: &impl IsA<Object>) -> bool {
        unsafe {
            from_glib(ffi::atk_object_remove_relationship(self.as_ref().to_glib_none().0, relationship.into_glib(), target.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_accessible_id(&self, name: &str) {
        unsafe {
            ffi::atk_object_set_accessible_id(self.as_ref().to_glib_none().0, name.to_glib_none().0);
        }
    }
    ...
    fn set_accessible_description(&self, accessible_description: Option<&str>) {
        ObjectExt::set_property(self.as_ref(),"accessible-description", accessible_description)
    }
    ...
    fn set_accessible_table_caption(&self, accessible_table_caption: Option<&str>) {
        ObjectExt::set_property(self.as_ref(),"accessible-table-caption", accessible_table_caption)
    }
    ...
    fn set_accessible_table_caption_object<P: IsA<Object>>(&self, accessible_table_caption_object: Option<&P>) {
        ObjectExt::set_property(self.as_ref(),"accessible-table-caption-object", accessible_table_caption_object)
    }
    ...
    fn set_accessible_table_column_description(&self, accessible_table_column_description: Option<&str>) {
        ObjectExt::set_property(self.as_ref(),"accessible-table-column-description", accessible_table_column_description)
    }
    ...
    fn set_accessible_table_column_header<P: IsA<Object>>(&self, accessible_table_column_header: Option<&P>) {
        ObjectExt::set_property(self.as_ref(),"accessible-table-column-header", accessible_table_column_header)
    }
    ...
    fn set_accessible_table_row_description(&self, accessible_table_row_description: Option<&str>) {
        ObjectExt::set_property(self.as_ref(),"accessible-table-row-description", accessible_table_row_description)
    }
    ...
    fn set_accessible_table_row_header<P: IsA<Object>>(&self, accessible_table_row_header: Option<&P>) {
        ObjectExt::set_property(self.as_ref(),"accessible-table-row-header", accessible_table_row_header)
    }
    ...
    fn set_accessible_table_summary<P: IsA<Object>>(&self, accessible_table_summary: Option<&P>) {
        ObjectExt::set_property(self.as_ref(),"accessible-table-summary", accessible_table_summary)
    }
    ...
    fn connect_active_descendant_changed<F: Fn(&Self, &Object) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn active_descendant_changed_trampoline<P: IsA<Object>, F: Fn(&P, &Object) + 'static>(this: *mut ffi::AtkObject, arg1: *mut ffi::AtkObject, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(arg1))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("active-descendant-changed::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"active-descendant-changed\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(active_descendant_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_announcement<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn announcement_trampoline<P: IsA<Object>, F: Fn(&P, &str) + 'static>(this: *mut ffi::AtkObject, arg1: *mut std::ffi::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(arg1))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"announcement\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(announcement_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_children_changed<F: Fn(&Self, u32, &Object) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn children_changed_trampoline<P: IsA<Object>, F: Fn(&P, u32, &Object) + 'static>(this: *mut ffi::AtkObject, arg1: std::ffi::c_uint, arg2: *mut ffi::AtkObject, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref(), arg1, &from_glib_borrow(arg2))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("children-changed::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"children-changed\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(children_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_notification<F: Fn(&Self, &str, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notification_trampoline<P: IsA<Object>, F: Fn(&P, &str, i32) + 'static>(this: *mut ffi::AtkObject, arg1: *mut std::ffi::c_char, arg2: std::ffi::c_int, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(arg1), arg2)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notification\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notification_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_state_change<F: Fn(&Self, &str, bool) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn state_change_trampoline<P: IsA<Object>, F: Fn(&P, &str, bool) + 'static>(this: *mut ffi::AtkObject, arg1: *mut std::ffi::c_char, arg2: glib::ffi::gboolean, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(arg1), from_glib(arg2))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("state-change::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"state-change\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(state_change_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "visible-data-changed")]
    fn connect_visible_data_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn visible_data_changed_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"visible-data-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(visible_data_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-component-layer")]
    fn connect_accessible_component_layer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_component_layer_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-component-layer\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_component_layer_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-component-mdi-zorder")]
    fn connect_accessible_component_mdi_zorder_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_component_mdi_zorder_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-component-mdi-zorder\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_component_mdi_zorder_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-description")]
    fn connect_accessible_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_description_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-description\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_description_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-hypertext-nlinks")]
    fn connect_accessible_hypertext_nlinks_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_hypertext_nlinks_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-hypertext-nlinks\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_hypertext_nlinks_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-name")]
    fn connect_accessible_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_name_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-name\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-parent")]
    fn connect_accessible_parent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_parent_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-parent\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_parent_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-role")]
    fn connect_accessible_role_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_role_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-role\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_role_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-table-caption")]
    fn connect_accessible_table_caption_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_table_caption_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-table-caption\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_table_caption_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-table-caption-object")]
    fn connect_accessible_table_caption_object_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_table_caption_object_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-table-caption-object\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_table_caption_object_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-table-column-description")]
    fn connect_accessible_table_column_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_table_column_description_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-table-column-description\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_table_column_description_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-table-column-header")]
    fn connect_accessible_table_column_header_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_table_column_header_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-table-column-header\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_table_column_header_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-table-row-description")]
    fn connect_accessible_table_row_description_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_table_row_description_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-table-row-description\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_table_row_description_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-table-row-header")]
    fn connect_accessible_table_row_header_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_table_row_header_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-table-row-header\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_table_row_header_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-table-summary")]
    fn connect_accessible_table_summary_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_table_summary_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-table-summary\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_table_summary_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accessible-value")]
    fn connect_accessible_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accessible_value_trampoline<P: IsA<Object>, F: Fn(&P) + 'static>(this: *mut ffi::AtkObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Object::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accessible-value\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(notify_accessible_value_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
