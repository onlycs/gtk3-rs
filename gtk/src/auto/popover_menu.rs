...
use crate::{Align,Bin,Buildable,Container,Popover,PopoverConstraint,PositionType,ResizeMode,Widget};
...
impl PopoverMenu {
    ...
    pub fn set_child_position<T: IsA<crate::Widget>>(&self, item: &T, position: i32) {
        crate::prelude::ContainerExtManual::child_set_property(self, &item.clone().upcast(),"position", &position)
    }
    ...
    pub fn set_child_submenu<T: IsA<crate::Widget>>(&self, item: &T, submenu: Option<&str>) {
        crate::prelude::ContainerExtManual::child_set_property(self, &item.clone().upcast(),"submenu", &submenu)
    }

    #[doc(alias = "visible-submenu")]
    pub fn connect_visible_submenu_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_visible_submenu_trampoline<F: Fn(&PopoverMenu) + 'static>(this: *mut ffi::GtkPopoverMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::visible-submenu\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_visible_submenu_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
...
pub struct PopoverMenuBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("visible-submenu", visible_submenu.into()), }
                        }
