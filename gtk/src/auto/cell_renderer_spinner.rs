...
pub trait CellRendererSpinnerExt: IsA<CellRendererSpinner> + sealed::Sealed + 'static {
    ...
    fn connect_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_active_trampoline<P: IsA<CellRendererSpinner>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererSpinner, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_pulse_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pulse_trampoline<P: IsA<CellRendererSpinner>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererSpinner, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererSpinner::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_size_trampoline<P: IsA<CellRendererSpinner>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererSpinner, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererSpinner::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
