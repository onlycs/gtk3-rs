...
pub struct EntryCompletionBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("inline-completion", inline_completion), }
                        }

                            pub fn inline_selection(self, inline_selection: bool) -> Self {
                            Self { builder: self.builder.property("inline-selection", inline_selection), }
                        }

                            pub fn minimum_key_length(self, minimum_key_length: i32) -> Self {
                            Self { builder: self.builder.property("minimum-key-length", minimum_key_length), }
                        }
                            ...
                            Self { builder: self.builder.property("popup-completion", popup_completion), }
                        }

                            pub fn popup_set_width(self, popup_set_width: bool) -> Self {
                            Self { builder: self.builder.property("popup-set-width", popup_set_width), }
                        }

                            pub fn popup_single_match(self, popup_single_match: bool) -> Self {
                            Self { builder: self.builder.property("popup-single-match", popup_single_match), }
                        }
...
pub trait EntryCompletionExt: IsA<EntryCompletion> + sealed::Sealed + 'static {
    ...
    fn set_inline_completion(&self, inline_completion: bool) {
        unsafe {
            ffi::gtk_entry_completion_set_inline_completion(self.as_ref().to_glib_none().0, inline_completion.into_glib());
        }
    }
    ...
    fn set_inline_selection(&self, inline_selection: bool) {
        unsafe {
            ffi::gtk_entry_completion_set_inline_selection(self.as_ref().to_glib_none().0, inline_selection.into_glib());
        }
    }
    ...
    fn set_match_func<P: Fn(&EntryCompletion, &str, &TreeIter) -> bool + 'static>(&self, func: P) {
        ...
        unsafe extern "C" fn func_func<P: Fn(&EntryCompletion, &str, &TreeIter) -> bool + 'static>(completion: *mut ffi::GtkEntryCompletion, key: *const libc::c_char, iter: *mut ffi::GtkTreeIter, user_data: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let completion = from_glib_borrow(completion);
            let key: Borrowed<glib::GString> = from_glib_borrow(key);
            let iter = from_glib_borrow(iter);
            let callback: &P = &*(user_data as *mut _);
            (*callback)(&completion, key.as_str(), &iter)
            .into_glib()
        }
        let func = Some(func_func::<P> as _);
        unsafe extern "C" fn func_notify_func<P: Fn(&EntryCompletion, &str, &TreeIter) -> bool + 'static>(data: glib::ffi::gpointer) {
            let _callback: Box_<P> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(func_notify_func::<P> as _);
        let super_callback0: Box_<P> = func_data;
        unsafe {
            ffi::gtk_entry_completion_set_match_func(self.as_ref().to_glib_none().0, func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_popup_completion(&self, popup_completion: bool) {
        unsafe {
            ffi::gtk_entry_completion_set_popup_completion(self.as_ref().to_glib_none().0, popup_completion.into_glib());
        }
    }
    ...
    fn set_popup_set_width(&self, popup_set_width: bool) {
        unsafe {
            ffi::gtk_entry_completion_set_popup_set_width(self.as_ref().to_glib_none().0, popup_set_width.into_glib());
        }
    }
    ...
    fn set_popup_single_match(&self, popup_single_match: bool) {
        unsafe {
            ffi::gtk_entry_completion_set_popup_single_match(self.as_ref().to_glib_none().0, popup_single_match.into_glib());
        }
    }
    ...
    fn connect_action_activated<F: Fn(&Self, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn action_activated_trampoline<P: IsA<EntryCompletion>, F: Fn(&P, i32) + 'static>(this: *mut ffi::GtkEntryCompletion, index: libc::c_int, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref(), index)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"action-activated\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(action_activated_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "cursor-on-match")]
    fn connect_cursor_on_match<F: Fn(&Self, &TreeModel, &TreeIter) -> glib::Propagation + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn cursor_on_match_trampoline<P: IsA<EntryCompletion>, F: Fn(&P, &TreeModel, &TreeIter) -> glib::Propagation + 'static>(this: *mut ffi::GtkEntryCompletion, model: *mut ffi::GtkTreeModel, iter: *mut ffi::GtkTreeIter, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(model), &from_glib_borrow(iter)).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"cursor-on-match\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(cursor_on_match_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "insert-prefix")]
    fn connect_insert_prefix<F: Fn(&Self, &str) -> glib::Propagation + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn insert_prefix_trampoline<P: IsA<EntryCompletion>, F: Fn(&P, &str) -> glib::Propagation + 'static>(this: *mut ffi::GtkEntryCompletion, prefix: *mut libc::c_char, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(prefix)).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"insert-prefix\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(insert_prefix_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "match-selected")]
    fn connect_match_selected<F: Fn(&Self, &TreeModel, &TreeIter) -> glib::Propagation + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn match_selected_trampoline<P: IsA<EntryCompletion>, F: Fn(&P, &TreeModel, &TreeIter) -> glib::Propagation + 'static>(this: *mut ffi::GtkEntryCompletion, model: *mut ffi::GtkTreeModel, iter: *mut ffi::GtkTreeIter, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(model), &from_glib_borrow(iter)).into_glib()
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"match-selected\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(match_selected_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "no-matches")]
    fn connect_no_matches<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn no_matches_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"no-matches\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(no_matches_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "inline-completion")]
    fn connect_inline_completion_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_inline_completion_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::inline-completion\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_inline_completion_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "inline-selection")]
    fn connect_inline_selection_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_inline_selection_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::inline-selection\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_inline_selection_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "minimum-key-length")]
    fn connect_minimum_key_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_minimum_key_length_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::minimum-key-length\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_minimum_key_length_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "model")]
    fn connect_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_model_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_popup_completion_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_popup_completion_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::popup-completion\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_popup_completion_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "popup-set-width")]
    fn connect_popup_set_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_popup_set_width_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::popup-set-width\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_popup_set_width_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "popup-single-match")]
    fn connect_popup_single_match_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_popup_single_match_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::popup-single-match\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_popup_single_match_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "text-column")]
    fn connect_text_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_column_trampoline<P: IsA<EntryCompletion>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEntryCompletion, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EntryCompletion::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
