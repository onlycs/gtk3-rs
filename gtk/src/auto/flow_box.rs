...
use crate::{Adjustment,Align,Buildable,Container,FlowBoxChild,MovementStep,Orientable,Orientation,ResizeMode,SelectionMode,Widget};
...
pub struct FlowBoxBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("max-children-per-line", max_children_per_line), }
                        }

                            pub fn min_children_per_line(self, min_children_per_line: u32) -> Self {
                            Self { builder: self.builder.property("min-children-per-line", min_children_per_line), }
                        }
...
pub trait FlowBoxExt: IsA<FlowBox> + sealed::Sealed + 'static {
    ...
    fn bind_model<P: Fn(&glib::Object) -> Widget + 'static>(&self, model: Option<&impl IsA<gio::ListModel>>, create_widget_func: P) {
        let create_widget_func_data: Box_<P> = Box_::new(create_widget_func);
        unsafe extern "C" fn create_widget_func_func<P: Fn(&glib::Object) -> Widget + 'static>(item: *mut glib::gobject_ffi::GObject, user_data: glib::ffi::gpointer) -> *mut ffi::GtkWidget {
        ...
        unsafe extern "C" fn user_data_free_func_func<P: Fn(&glib::Object) -> Widget + 'static>(data: glib::ffi::gpointer) {
            let _callback: Box_<P> = Box_::from_raw(data as *mut _);
        }
        let destroy_call4 = Some(user_data_free_func_func::<P> as _);
        let super_callback0: Box_<P> = create_widget_func_data;
        unsafe {
            ffi::gtk_flow_box_bind_model(self.as_ref().to_glib_none().0, model.map(|p| p.as_ref()).to_glib_none().0, create_widget_func, Box_::into_raw(super_callback0) as *mut _, destroy_call4);
        }
    }
    ...
    fn selected_foreach<P: FnMut(&FlowBox, &FlowBoxChild)>(&self, func: P) {
        ...
        unsafe extern "C" fn func_func<P: FnMut(&FlowBox, &FlowBoxChild)>(box_: *mut ffi::GtkFlowBox, child: *mut ffi::GtkFlowBoxChild, user_data: glib::ffi::gpointer) {
    ...
    fn set_activate_on_single_click(&self, single: bool) {
        unsafe {
            ffi::gtk_flow_box_set_activate_on_single_click(self.as_ref().to_glib_none().0, single.into_glib());
        }
    }
    ...
    fn set_filter_func(&self, filter_func: Option<Box_<dyn Fn(&FlowBoxChild) -> bool + 'static>>) {
        let filter_func_data: Box_<Option<Box_<dyn Fn(&FlowBoxChild) -> bool + 'static>>> = Box_::new(filter_func);
        unsafe extern "C" fn filter_func_func(child: *mut ffi::GtkFlowBoxChild, user_data: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let child = from_glib_borrow(child);
            let callback: &Option<Box_<dyn Fn(&FlowBoxChild) -> bool + 'static>> = &*(user_data as *mut _);
        ...
        unsafe extern "C" fn destroy_func(data: glib::ffi::gpointer) {
            let _callback: Box_<Option<Box_<dyn Fn(&FlowBoxChild) -> bool + 'static>>> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(destroy_func as _);
        let super_callback0: Box_<Option<Box_<dyn Fn(&FlowBoxChild) -> bool + 'static>>> = filter_func_data;
        unsafe {
            ffi::gtk_flow_box_set_filter_func(self.as_ref().to_glib_none().0, filter_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_homogeneous(&self, homogeneous: bool) {
        unsafe {
            ffi::gtk_flow_box_set_homogeneous(self.as_ref().to_glib_none().0, homogeneous.into_glib());
        }
    }
    ...
    fn set_sort_func(&self, sort_func: Option<Box_<dyn Fn(&FlowBoxChild, &FlowBoxChild) -> i32 + 'static>>) {
        let sort_func_data: Box_<Option<Box_<dyn Fn(&FlowBoxChild, &FlowBoxChild) -> i32 + 'static>>> = Box_::new(sort_func);
        unsafe extern "C" fn sort_func_func(child1: *mut ffi::GtkFlowBoxChild, child2: *mut ffi::GtkFlowBoxChild, user_data: glib::ffi::gpointer) -> libc::c_int {
            let child1 = from_glib_borrow(child1);
            let child2 = from_glib_borrow(child2);
            let callback: &Option<Box_<dyn Fn(&FlowBoxChild, &FlowBoxChild) -> i32 + 'static>> = &*(user_data as *mut _);
            if let Some(ref callback) = *callback {
        ...
        unsafe extern "C" fn destroy_func(data: glib::ffi::gpointer) {
            let _callback: Box_<Option<Box_<dyn Fn(&FlowBoxChild, &FlowBoxChild) -> i32 + 'static>>> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(destroy_func as _);
        let super_callback0: Box_<Option<Box_<dyn Fn(&FlowBoxChild, &FlowBoxChild) -> i32 + 'static>>> = sort_func_data;
        unsafe {
            ffi::gtk_flow_box_set_sort_func(self.as_ref().to_glib_none().0, sort_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn connect_activate_cursor_child<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activate_cursor_child_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"activate-cursor-child\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(activate_cursor_child_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_child_activated<F: Fn(&Self, &FlowBoxChild) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn child_activated_trampoline<P: IsA<FlowBox>, F: Fn(&P, &FlowBoxChild) + 'static>(this: *mut ffi::GtkFlowBox, child: *mut ffi::GtkFlowBoxChild, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(child))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"child-activated\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(child_activated_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "move-cursor")]
    fn connect_move_cursor<F: Fn(&Self, MovementStep, i32) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn move_cursor_trampoline<P: IsA<FlowBox>, F: Fn(&P, MovementStep, i32) -> bool + 'static>(this: *mut ffi::GtkFlowBox, step: ffi::GtkMovementStep, count: libc::c_int, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref(), from_glib(step), count).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_select_all<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn select_all_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_selected_children_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn selected_children_changed_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"selected-children-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(selected_children_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "toggle-cursor-child")]
    fn connect_toggle_cursor_child<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn toggle_cursor_child_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"toggle-cursor-child\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(toggle_cursor_child_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_unselect_all<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn unselect_all_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_activate_on_single_click_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_activate_on_single_click_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_column_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_column_spacing_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_homogeneous_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_homogeneous_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::homogeneous\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_homogeneous_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "max-children-per-line")]
    fn connect_max_children_per_line_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_max_children_per_line_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::max-children-per-line\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_max_children_per_line_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "min-children-per-line")]
    fn connect_min_children_per_line_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_min_children_per_line_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::min-children-per-line\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_min_children_per_line_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "row-spacing")]
    fn connect_row_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_row_spacing_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_selection_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selection_mode_trampoline<P: IsA<FlowBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFlowBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FlowBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
