...
pub trait EventBoxExt: IsA<EventBox> + sealed::Sealed + 'static {
    ...
    fn set_above_child(&self, above_child: bool) {
        unsafe {
            ffi::gtk_event_box_set_above_child(self.as_ref().to_glib_none().0, above_child.into_glib());
        }
    }
    ...
    fn set_visible_window(&self, visible_window: bool) {
        unsafe {
            ffi::gtk_event_box_set_visible_window(self.as_ref().to_glib_none().0, visible_window.into_glib());
        }
    }

    #[doc(alias = "above-child")]
    fn connect_above_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_above_child_trampoline<P: IsA<EventBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEventBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::above-child\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_above_child_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "visible-window")]
    fn connect_visible_window_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_visible_window_trampoline<P: IsA<EventBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkEventBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(EventBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::visible-window\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_visible_window_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
