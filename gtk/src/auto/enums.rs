...
impl IconSize {
    ...
    pub fn lookup(self) -> Option<(i32, i32)> {
        ...
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_icon_size_lookup(self.into_glib(), width.as_mut_ptr(), height.as_mut_ptr()));
...
match self {
            ...
            Self::GestureRotateCounterclockwise => ffi::GTK_SHORTCUT_GESTURE_ROTATE_COUNTERCLOCKWISE,
...
match value {
            ...
            ffi::GTK_SHORTCUT_GESTURE_ROTATE_COUNTERCLOCKWISE => Self::GestureRotateCounterclockwise,
