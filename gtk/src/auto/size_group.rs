...
impl SizeGroup {
    ...
    pub fn new(mode: SizeGroupMode) -> SizeGroup {
        ...
        unsafe {
            from_glib_full(ffi::gtk_size_group_new(mode.into_glib()))
        }
    }
...
pub trait SizeGroupExt: IsA<SizeGroup> + sealed::Sealed + 'static {
    ...
    fn connect_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_mode_trampoline<P: IsA<SizeGroup>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSizeGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
