...
use crate::{Align,BaselinePosition,Box,Buildable,Container,FileChooser,FileChooserAction,FileFilter,Orientable,Orientation,ResizeMode,Widget};
...
impl FileChooserWidget {
    ...
    pub fn new(action: FileChooserAction) -> FileChooserWidget {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_file_chooser_widget_new(action.into_glib())).unsafe_cast()
        }
    }
...
pub struct FileChooserWidgetBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("search-mode", search_mode), }
                        }
                            ...
                            Self { builder: self.builder.property("action", action), }
                        }

                            pub fn create_folders(self, create_folders: bool) -> Self {
                            Self { builder: self.builder.property("create-folders", create_folders), }
                        }

                            pub fn do_overwrite_confirmation(self, do_overwrite_confirmation: bool) -> Self {
                            Self { builder: self.builder.property("do-overwrite-confirmation", do_overwrite_confirmation), }
                        }
                            ...
                            Self { builder: self.builder.property("filter", filter.clone()), }
                        }
                            ...
                            Self { builder: self.builder.property("preview-widget", preview_widget.clone().upcast()), }
                        }

                            pub fn preview_widget_active(self, preview_widget_active: bool) -> Self {
                            Self { builder: self.builder.property("preview-widget-active", preview_widget_active), }
                        }

                            pub fn select_multiple(self, select_multiple: bool) -> Self {
                            Self { builder: self.builder.property("select-multiple", select_multiple), }
                        }
                            ...
                            Self { builder: self.builder.property("use-preview-label", use_preview_label), }
                        }
...
pub trait FileChooserWidgetExt: IsA<FileChooserWidget> + sealed::Sealed + 'static {
    ...
    fn connect_desktop_folder<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn desktop_folder_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"desktop-folder\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(desktop_folder_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_down_folder<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn down_folder_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"down-folder\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(down_folder_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_home_folder<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn home_folder_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"home-folder\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(home_folder_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_location_popup<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn location_popup_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P, &str) + 'static>(this: *mut ffi::GtkFileChooserWidget, path: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(path))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"location-popup\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(location_popup_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_location_popup_on_paste<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn location_popup_on_paste_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"location-popup-on-paste\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(location_popup_on_paste_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_location_toggle_popup<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn location_toggle_popup_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"location-toggle-popup\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(location_toggle_popup_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_places_shortcut<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn places_shortcut_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"places-shortcut\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(places_shortcut_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_quick_bookmark<F: Fn(&Self, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn quick_bookmark_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P, i32) + 'static>(this: *mut ffi::GtkFileChooserWidget, bookmark_index: libc::c_int, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref(), bookmark_index)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"quick-bookmark\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(quick_bookmark_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_recent_shortcut<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn recent_shortcut_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"recent-shortcut\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(recent_shortcut_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_search_shortcut<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn search_shortcut_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"search-shortcut\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(search_shortcut_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_show_hidden<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_hidden_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"show-hidden\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(show_hidden_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_up_folder<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn up_folder_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"up-folder\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(up_folder_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_search_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_search_mode_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::search-mode\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_search_mode_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "subtitle")]
    fn connect_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_subtitle_trampoline<P: IsA<FileChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::subtitle\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_subtitle_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
