...
pub struct MountOperationBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("anonymous", anonymous), }
                        }

                            pub fn choice(self, choice: i32) -> Self {
                            Self { builder: self.builder.property("choice", choice), }
                        }

                            pub fn domain(self, domain: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("domain", domain.into()), }
                        }
    ...
    pub fn is_tcrypt_hidden_volume(self, is_tcrypt_hidden_volume: bool) -> Self {
                            Self { builder: self.builder.property("is-tcrypt-hidden-volume", is_tcrypt_hidden_volume), }
                        }

                            #[cfg(feature = "gio_v2_58")]
    #[cfg_attr(docsrs, doc(cfg(feature = "gio_v2_58")))]
    pub fn is_tcrypt_system_volume(self, is_tcrypt_system_volume: bool) -> Self {
                            Self { builder: self.builder.property("is-tcrypt-system-volume", is_tcrypt_system_volume), }
                        }
    ...
    pub fn pim(self, pim: u32) -> Self {
                            Self { builder: self.builder.property("pim", pim), }
                        }
...
pub trait GtkMountOperationExt: IsA<MountOperation> + sealed::Sealed + 'static {
    ...
    fn connect_is_showing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_showing_trampoline<P: IsA<MountOperation>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMountOperation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::is-showing\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_is_showing_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "parent")]
    fn connect_parent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_parent_trampoline<P: IsA<MountOperation>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMountOperation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(MountOperation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_screen_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_screen_trampoline<P: IsA<MountOperation>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMountOperation, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(MountOperation::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
