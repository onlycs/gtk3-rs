...
use crate::{Actionable,Activatable,Align,Bin,Buildable,Button,Container,FontChooser,PositionType,ReliefStyle,ResizeMode,Widget};
#[cfg(feature = "v3_24")]
...
glib::wrapper! {
    ...
    pub struct FontButton(Object<ffi::GtkFontButton, ffi::GtkFontButtonClass>) @extends Button, Bin, Container, Widget, @implements Buildable, Actionable, Activatable, FontChooser;
...
pub struct FontButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("show-size", show_size), }
                        }

                            pub fn show_style(self, show_style: bool) -> Self {
                            Self { builder: self.builder.property("show-style", show_style), }
                        }
                            ...
                            Self { builder: self.builder.property("use-font", use_font), }
                        }

                            pub fn use_size(self, use_size: bool) -> Self {
                            Self { builder: self.builder.property("use-size", use_size), }
                        }
    ...
    pub fn level(self, level: FontChooserLevel) -> Self {
                            Self { builder: self.builder.property("level", level), }
                        }

                            pub fn preview_text(self, preview_text: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("preview-text", preview_text.into()), }
                        }

                            pub fn show_preview_entry(self, show_preview_entry: bool) -> Self {
                            Self { builder: self.builder.property("show-preview-entry", show_preview_entry), }
                        }
...
pub trait FontButtonExt: IsA<FontButton> + sealed::Sealed + 'static {
    ...
    fn set_show_size(&self, show_size: bool) {
        unsafe {
            ffi::gtk_font_button_set_show_size(self.as_ref().to_glib_none().0, show_size.into_glib());
        }
    }
    ...
    fn set_show_style(&self, show_style: bool) {
        unsafe {
            ffi::gtk_font_button_set_show_style(self.as_ref().to_glib_none().0, show_style.into_glib());
        }
    }
    ...
    fn connect_font_set<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn font_set_trampoline<P: IsA<FontButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFontButton, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"font-set\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(font_set_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-size")]
    fn connect_show_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_size_trampoline<P: IsA<FontButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFontButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FontButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-size\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_size_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-style")]
    fn connect_show_style_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_style_trampoline<P: IsA<FontButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFontButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FontButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-style\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_style_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "title")]
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<FontButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFontButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FontButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_use_font_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_use_font_trampoline<P: IsA<FontButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFontButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FontButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::use-font\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_use_font_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "use-size")]
    fn connect_use_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_use_size_trampoline<P: IsA<FontButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFontButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FontButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::use-size\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_use_size_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
