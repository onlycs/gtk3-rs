...
use crate::{Adjustment,Align,Buildable,CellArea,CellLayout,CellRenderer,Container,IconViewDropPosition,MovementStep,Orientation,ResizeMode,Scrollable,ScrollablePolicy,SelectionMode,Tooltip,TreeIter,TreeModel,TreePath,Widget};
...
pub struct IconViewBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("cell-area", cell_area.clone().upcast()), }
                        }
                            ...
                            Self { builder: self.builder.property("columns", columns), }
                        }

                            pub fn item_orientation(self, item_orientation: Orientation) -> Self {
                            Self { builder: self.builder.property("item-orientation", item_orientation), }
                        }

                            pub fn item_padding(self, item_padding: i32) -> Self {
                            Self { builder: self.builder.property("item-padding", item_padding), }
                        }

                            pub fn item_width(self, item_width: i32) -> Self {
                            Self { builder: self.builder.property("item-width", item_width), }
                        }
                            ...
                            Self { builder: self.builder.property("markup-column", markup_column), }
                        }
                            ...
                            Self { builder: self.builder.property("pixbuf-column", pixbuf_column), }
                        }
                            ...
                            Self { builder: self.builder.property("selection-mode", selection_mode), }
                        }
                            ...
                            Self { builder: self.builder.property("text-column", text_column), }
                        }
...
pub trait IconViewExt: IsA<IconView> + sealed::Sealed + 'static {
    ...
    fn convert_widget_to_bin_window_coords(&self, wx: i32, wy: i32) -> (i32, i32) {
        unsafe {
            ...
            ffi::gtk_icon_view_convert_widget_to_bin_window_coords(self.as_ref().to_glib_none().0, wx, wy, bx.as_mut_ptr(), by.as_mut_ptr());
    ...
    fn cell_rect(&self, path: &TreePath, cell: Option<&impl IsA<CellRenderer>>) -> Option<gdk::Rectangle> {
        unsafe {
    ...
    fn dest_item_at_pos(&self, drag_x: i32, drag_y: i32) -> Option<(TreePath, IconViewDropPosition)> {
        unsafe {
            let mut path = std::ptr::null_mut();
            let mut pos = std::mem::MaybeUninit::uninit();
            let ret = from_glib(ffi::gtk_icon_view_get_dest_item_at_pos(self.as_ref().to_glib_none().0, drag_x, drag_y, &mut path, pos.as_mut_ptr()));
    ...
    fn drag_dest_item(&self) -> (TreePath, IconViewDropPosition) {
        unsafe {
            let mut path = std::ptr::null_mut();
            let mut pos = std::mem::MaybeUninit::uninit();
            ffi::gtk_icon_view_get_drag_dest_item(self.as_ref().to_glib_none().0, &mut path, pos.as_mut_ptr());
    ...
    fn tooltip_context(&self, x: &mut i32, y: &mut i32, keyboard_tip: bool) -> Option<(TreeModel, TreePath, TreeIter)> {
        unsafe {
            let mut model = std::ptr::null_mut();
            let mut path = std::ptr::null_mut();
            let mut iter = TreeIter::uninitialized();
            let ret = from_glib(ffi::gtk_icon_view_get_tooltip_context(self.as_ref().to_glib_none().0, x, y, keyboard_tip.into_glib(), &mut model, &mut path, iter.to_glib_none_mut().0));
    ...
    fn scroll_to_path(&self, path: &TreePath, use_align: bool, row_align: f32, col_align: f32) {
        unsafe {
            ffi::gtk_icon_view_scroll_to_path(self.as_ref().to_glib_none().0, mut_override(path.to_glib_none().0), use_align.into_glib(), row_align, col_align);
        }
    }
    ...
    fn selected_foreach<P: FnMut(&IconView, &TreePath)>(&self, func: P) {
        ...
        unsafe extern "C" fn func_func<P: FnMut(&IconView, &TreePath)>(icon_view: *mut ffi::GtkIconView, path: *mut ffi::GtkTreePath, data: glib::ffi::gpointer) {
    ...
    fn set_activate_on_single_click(&self, single: bool) {
        unsafe {
            ffi::gtk_icon_view_set_activate_on_single_click(self.as_ref().to_glib_none().0, single.into_glib());
        }
    }
    ...
    fn set_cursor(&self, path: &TreePath, cell: Option<&impl IsA<CellRenderer>>, start_editing: bool) {
        unsafe {
            ffi::gtk_icon_view_set_cursor(self.as_ref().to_glib_none().0, mut_override(path.to_glib_none().0), cell.map(|p| p.as_ref()).to_glib_none().0, start_editing.into_glib());
        }
    }
    ...
    fn set_drag_dest_item(&self, path: Option<&TreePath>, pos: IconViewDropPosition) {
        unsafe {
            ffi::gtk_icon_view_set_drag_dest_item(self.as_ref().to_glib_none().0, mut_override(path.to_glib_none().0), pos.into_glib());
        }
    }
    ...
    fn set_item_orientation(&self, orientation: Orientation) {
        unsafe {
            ffi::gtk_icon_view_set_item_orientation(self.as_ref().to_glib_none().0, orientation.into_glib());
        }
    }
    ...
    fn set_reorderable(&self, reorderable: bool) {
        unsafe {
            ffi::gtk_icon_view_set_reorderable(self.as_ref().to_glib_none().0, reorderable.into_glib());
        }
    }
    ...
    fn set_tooltip_cell(&self, tooltip: &Tooltip, path: &TreePath, cell: Option<&impl IsA<CellRenderer>>) {
        unsafe {
    ...
    fn connect_activate_cursor_item<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activate_cursor_item_trampoline<P: IsA<IconView>, F: Fn(&P) -> bool + 'static>(this: *mut ffi::GtkIconView, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"activate-cursor-item\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(activate_cursor_item_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_item_activated<F: Fn(&Self, &TreePath) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn item_activated_trampoline<P: IsA<IconView>, F: Fn(&P, &TreePath) + 'static>(this: *mut ffi::GtkIconView, path: *mut ffi::GtkTreePath, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(path))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"item-activated\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(item_activated_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "move-cursor")]
    fn connect_move_cursor<F: Fn(&Self, MovementStep, i32) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn move_cursor_trampoline<P: IsA<IconView>, F: Fn(&P, MovementStep, i32) -> bool + 'static>(this: *mut ffi::GtkIconView, step: ffi::GtkMovementStep, count: libc::c_int, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref(), from_glib(step), count).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_select_all<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn select_all_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
    ...
    fn connect_select_cursor_item<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn select_cursor_item_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"select-cursor-item\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(select_cursor_item_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_selection_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn selection_changed_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_toggle_cursor_item<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn toggle_cursor_item_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"toggle-cursor-item\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(toggle_cursor_item_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_unselect_all<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn unselect_all_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_activate_on_single_click_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_activate_on_single_click_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_column_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_column_spacing_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_columns_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_columns_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::columns\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_columns_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "item-orientation")]
    fn connect_item_orientation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_item_orientation_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::item-orientation\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_item_orientation_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "item-padding")]
    fn connect_item_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_item_padding_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::item-padding\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_item_padding_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "item-width")]
    fn connect_item_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_item_width_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::item-width\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_item_width_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "markup-column")]
    fn connect_markup_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_markup_column_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::markup-column\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_markup_column_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "model")]
    fn connect_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_model_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_pixbuf_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pixbuf_column_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::pixbuf-column\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_pixbuf_column_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "reorderable")]
    fn connect_reorderable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_reorderable_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_row_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_row_spacing_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_selection_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selection_mode_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::selection-mode\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_selection_mode_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "spacing")]
    fn connect_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_spacing_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::spacing\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_spacing_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "text-column")]
    fn connect_text_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_column_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::text-column\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_text_column_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "tooltip-column")]
    fn connect_tooltip_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tooltip_column_trampoline<P: IsA<IconView>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconView, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IconView::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
