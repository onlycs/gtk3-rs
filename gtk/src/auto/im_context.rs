...
pub trait IMContextExt: IsA<IMContext> + sealed::Sealed + 'static {
    ...
    fn preedit_string(&self) -> (glib::GString, pango::AttrList, i32) {
        unsafe {
            ...
            ffi::gtk_im_context_get_preedit_string(self.as_ref().to_glib_none().0, &mut str, &mut attrs, cursor_pos.as_mut_ptr());
            (from_glib_full(str), from_glib_full(attrs), cursor_pos.assume_init())
        }
    }
    ...
    fn surrounding(&self) -> Option<(glib::GString, i32)> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_im_context_get_surrounding(self.as_ref().to_glib_none().0, &mut text, cursor_index.as_mut_ptr()));
            if ret { Some((from_glib_full(text), cursor_index.assume_init())) } else { None }
        }
    }
    ...
    fn set_client_window(&self, window: Option<&gdk::Window>) {
        unsafe {
            ffi::gtk_im_context_set_client_window(self.as_ref().to_glib_none().0, window.to_glib_none().0);
        }
    }
    ...
    fn set_use_preedit(&self, use_preedit: bool) {
        unsafe {
            ffi::gtk_im_context_set_use_preedit(self.as_ref().to_glib_none().0, use_preedit.into_glib());
        }
    }
    ...
    fn connect_commit<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn commit_trampoline<P: IsA<IMContext>, F: Fn(&P, &str) + 'static>(this: *mut ffi::GtkIMContext, str: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IMContext::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(str))
        }
        unsafe {
    ...
    fn connect_delete_surrounding<F: Fn(&Self, i32, i32) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn delete_surrounding_trampoline<P: IsA<IMContext>, F: Fn(&P, i32, i32) -> bool + 'static>(this: *mut ffi::GtkIMContext, offset: libc::c_int, n_chars: libc::c_int, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(IMContext::from_glib_borrow(this).unsafe_cast_ref(), offset, n_chars).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_preedit_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn preedit_changed_trampoline<P: IsA<IMContext>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIMContext, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
    ...
    fn connect_preedit_end<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn preedit_end_trampoline<P: IsA<IMContext>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIMContext, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IMContext::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"preedit-end\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(preedit_end_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "preedit-start")]
    fn connect_preedit_start<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn preedit_start_trampoline<P: IsA<IMContext>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIMContext, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IMContext::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"preedit-start\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(preedit_start_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "retrieve-surrounding")]
    fn connect_retrieve_surrounding<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn retrieve_surrounding_trampoline<P: IsA<IMContext>, F: Fn(&P) -> bool + 'static>(this: *mut ffi::GtkIMContext, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"retrieve-surrounding\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(retrieve_surrounding_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "input-hints")]
    fn connect_input_hints_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_input_hints_trampoline<P: IsA<IMContext>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIMContext, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IMContext::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_input_purpose_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_input_purpose_trampoline<P: IsA<IMContext>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIMContext, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(IMContext::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
