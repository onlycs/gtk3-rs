...
pub trait CellRendererSpinExt: IsA<CellRendererSpin> + sealed::Sealed + 'static {
    ...
    fn connect_adjustment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_adjustment_trampoline<P: IsA<CellRendererSpin>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererSpin, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_climb_rate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_climb_rate_trampoline<P: IsA<CellRendererSpin>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererSpin, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererSpin::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_digits_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_digits_trampoline<P: IsA<CellRendererSpin>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererSpin, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererSpin::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
