...
use crate::{Align,AppChooser,Application,Bin,Buildable,Container,Dialog,DialogFlags,ResizeMode,Widget,Window,WindowPosition,WindowType};
...
impl AppChooserDialog {
    ...
    pub fn new(parent: Option<&impl IsA<Window>>, flags: DialogFlags, file: &impl IsA<gio::File>) -> AppChooserDialog {
        assert_initialized_main_thread!();
        unsafe {
            Widget::from_glib_none(ffi::gtk_app_chooser_dialog_new(parent.map(|p| p.as_ref()).to_glib_none().0, flags.into_glib(), file.as_ref().to_glib_none().0)).unsafe_cast()
        }
    }

    #[doc(alias = "gtk_app_chooser_dialog_new_for_content_type")]
    #[doc(alias = "new_for_content_type")]
    pub fn for_content_type(parent: Option<&impl IsA<Window>>, flags: DialogFlags, content_type: &str) -> AppChooserDialog {
        assert_initialized_main_thread!();
        unsafe {
            Widget::from_glib_none(ffi::gtk_app_chooser_dialog_new_for_content_type(parent.map(|p| p.as_ref()).to_glib_none().0, flags.into_glib(), content_type.to_glib_none().0)).unsafe_cast()
        }
    }
...
pub struct AppChooserDialogBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("gfile", gfile.clone().upcast()), }
                        }
...
pub trait AppChooserDialogExt: IsA<AppChooserDialog> + sealed::Sealed + 'static {
    ...
    fn connect_heading_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_heading_trampoline<P: IsA<AppChooserDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
