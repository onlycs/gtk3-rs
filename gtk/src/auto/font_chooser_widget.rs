...
use crate::{Align,BaselinePosition,Box,Buildable,Container,FontChooser,Orientable,Orientation,ResizeMode,Widget};
#[cfg(feature = "v3_24")]
...
pub trait FontChooserWidgetExt: IsA<FontChooserWidget> + sealed::Sealed + 'static {
    ...
    fn connect_tweak_action_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tweak_action_trampoline<P: IsA<FontChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFontChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::tweak-action\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_tweak_action_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
