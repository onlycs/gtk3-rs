...
use crate::{Align,BaselinePosition,Box,Buildable,Container,Dialog,FileChooser,FileChooserAction,FileFilter,Orientable,Orientation,ResizeMode,Widget};
...
impl FileChooserButton {
    ...
    pub fn new(title: &str, action: FileChooserAction) -> FileChooserButton {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_file_chooser_button_new(title.to_glib_none().0, action.into_glib())).unsafe_cast()
        }
    }
...
pub struct FileChooserButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("dialog", dialog.clone().upcast()), }
                        }
...
pub trait FileChooserButtonExt: IsA<FileChooserButton> + sealed::Sealed + 'static {
    ...
    fn connect_file_set<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn file_set_trampoline<P: IsA<FileChooserButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserButton, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"file-set\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(file_set_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "title")]
    fn connect_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_title_trampoline<P: IsA<FileChooserButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_width_chars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_chars_trampoline<P: IsA<FileChooserButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkFileChooserButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(FileChooserButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
