...
use crate::{Actionable,Activatable,Adjustment,Align,Bin,Buildable,Button,Container,IconSize,Orientable,Orientation,PositionType,ReliefStyle,ResizeMode,ScaleButton,Widget};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_};

glib::wrapper! {
    #[doc(alias = "GtkVolumeButton")]
    pub struct VolumeButton(Object<ffi::GtkVolumeButton, ffi::GtkVolumeButtonClass>) @extends ScaleButton, Button, Bin, Container, Widget, @implements Buildable, Actionable, Activatable, Orientable;
...
pub struct VolumeButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("use-symbolic", use_symbolic), }
                        }
...
pub trait VolumeButtonExt: IsA<VolumeButton> + sealed::Sealed + 'static {
    ...
    fn connect_use_symbolic_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_use_symbolic_trampoline<P: IsA<VolumeButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkVolumeButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::use-symbolic\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_use_symbolic_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
