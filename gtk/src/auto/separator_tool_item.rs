...
use crate::{Activatable,Align,Bin,Buildable,Container,ResizeMode,ToolItem,Widget};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_};

glib::wrapper! {
    #[doc(alias = "GtkSeparatorToolItem")]
    pub struct SeparatorToolItem(Object<ffi::GtkSeparatorToolItem, ffi::GtkSeparatorToolItemClass>) @extends ToolItem, Bin, Container, Widget, @implements Buildable, Activatable;
...
pub struct SeparatorToolItemBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("draw", draw), }
                        }
...
pub trait SeparatorToolItemExt: IsA<SeparatorToolItem> + sealed::Sealed + 'static {
    ...
    fn connect_draw_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_draw_trampoline<P: IsA<SeparatorToolItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSeparatorToolItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::draw\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_draw_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
