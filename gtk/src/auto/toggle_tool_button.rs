...
use crate::{Actionable,Activatable,Align,Bin,Buildable,Container,ResizeMode,ToolButton,ToolItem,Widget};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_};

glib::wrapper! {
    #[doc(alias = "GtkToggleToolButton")]
    pub struct ToggleToolButton(Object<ffi::GtkToggleToolButton, ffi::GtkToggleToolButtonClass>) @extends ToolButton, ToolItem, Bin, Container, Widget, @implements Buildable, Activatable, Actionable;
...
pub trait ToggleToolButtonExt: IsA<ToggleToolButton> + sealed::Sealed + 'static {
    ...
    fn set_active(&self, is_active: bool) {
        unsafe {
            ffi::gtk_toggle_tool_button_set_active(self.as_ref().to_glib_none().0, is_active.into_glib());
        }
    }

    #[doc(alias = "toggled")]
    fn connect_toggled<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn toggled_trampoline<P: IsA<ToggleToolButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToggleToolButton, f: glib::ffi::gpointer) {
    ...
    fn connect_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_active_trampoline<P: IsA<ToggleToolButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToggleToolButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToggleToolButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
