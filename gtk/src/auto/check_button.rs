...
use crate::{Actionable,Activatable,Align,Bin,Buildable,Button,Container,PositionType,ReliefStyle,ResizeMode,ToggleButton,Widget};
use glib::{prelude::*,translate::*};

glib::wrapper! {
    #[doc(alias = "GtkCheckButton")]
    pub struct CheckButton(Object<ffi::GtkCheckButton, ffi::GtkCheckButtonClass>) @extends ToggleButton, Button, Bin, Container, Widget, @implements Buildable, Actionable, Activatable;
