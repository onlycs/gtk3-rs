...
use crate::{AccelGroup,Align,Buildable,Container,MenuItem,MenuShell,ResizeMode,ScrollType,Widget};
...
pub struct MenuBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("accel-group", accel_group.clone().upcast()), }
                        }
                            ...
                            Self { builder: self.builder.property("anchor-hints", anchor_hints), }
                        }

                            pub fn attach_widget(self, attach_widget: &impl IsA<Widget>) -> Self {
                            Self { builder: self.builder.property("attach-widget", attach_widget.clone().upcast()), }
                        }

                            pub fn menu_type_hint(self, menu_type_hint: gdk::WindowTypeHint) -> Self {
                            Self { builder: self.builder.property("menu-type-hint", menu_type_hint), }
                        }
                            ...
                            Self { builder: self.builder.property("rect-anchor-dx", rect_anchor_dx), }
                        }

                            pub fn rect_anchor_dy(self, rect_anchor_dy: i32) -> Self {
                            Self { builder: self.builder.property("rect-anchor-dy", rect_anchor_dy), }
                        }

                            pub fn reserve_toggle_size(self, reserve_toggle_size: bool) -> Self {
                            Self { builder: self.builder.property("reserve-toggle-size", reserve_toggle_size), }
                        }

                            pub fn take_focus(self, take_focus: bool) -> Self {
                            Self { builder: self.builder.property("take-focus", take_focus), }
                        }
...
pub trait GtkMenuExt: IsA<Menu> + sealed::Sealed + 'static {
    ...
    fn place_on_monitor(&self, monitor: &gdk::Monitor) {
        unsafe {
            ffi::gtk_menu_place_on_monitor(self.as_ref().to_glib_none().0, monitor.to_glib_none().0);
        }
    }
    ...
    fn popup_at_rect(&self, rect_window: &gdk::Window, rect: &gdk::Rectangle, rect_anchor: gdk::Gravity, menu_anchor: gdk::Gravity, trigger_event: Option<&gdk::Event>) {
        unsafe {
            ffi::gtk_menu_popup_at_rect(self.as_ref().to_glib_none().0, rect_window.to_glib_none().0, rect.to_glib_none().0, rect_anchor.into_glib(), menu_anchor.into_glib(), trigger_event.to_glib_none().0);
        }
    }

    #[doc(alias = "gtk_menu_popup_at_widget")]
    fn popup_at_widget(&self, widget: &impl IsA<Widget>, widget_anchor: gdk::Gravity, menu_anchor: gdk::Gravity, trigger_event: Option<&gdk::Event>) {
        unsafe {
            ffi::gtk_menu_popup_at_widget(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, widget_anchor.into_glib(), menu_anchor.into_glib(), trigger_event.to_glib_none().0);
        }
    }
    ...
    fn set_reserve_toggle_size(&self, reserve_toggle_size: bool) {
        unsafe {
            ffi::gtk_menu_set_reserve_toggle_size(self.as_ref().to_glib_none().0, reserve_toggle_size.into_glib());
        }
    }
    ...
    fn item_bottom_attach<T: IsA<MenuItem>>(&self, item: &T) -> i32 {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"bottom-attach")
    }

    #[doc(alias = "item.bottom-attach")]
    fn set_item_bottom_attach<T: IsA<MenuItem>>(&self, item: &T, bottom_attach: i32) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"bottom-attach", &bottom_attach)
    }
    ...
    fn item_right_attach<T: IsA<MenuItem>>(&self, item: &T) -> i32 {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"right-attach")
    }

    #[doc(alias = "item.right-attach")]
    fn set_item_right_attach<T: IsA<MenuItem>>(&self, item: &T, right_attach: i32) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"right-attach", &right_attach)
    }
    ...
    fn connect_move_scroll<F: Fn(&Self, ScrollType) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn move_scroll_trampoline<P: IsA<Menu>, F: Fn(&P, ScrollType) + 'static>(this: *mut ffi::GtkMenu, scroll_type: ffi::GtkScrollType, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref(), from_glib(scroll_type))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"move-scroll\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(move_scroll_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_accel_group_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_group_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-group\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_accel_group_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accel-path")]
    fn connect_accel_path_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_path_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-path\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_accel_path_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "active")]
    fn connect_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_active_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_anchor_hints_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_anchor_hints_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::anchor-hints\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_anchor_hints_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "attach-widget")]
    fn connect_attach_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_attach_widget_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::attach-widget\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_attach_widget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "menu-type-hint")]
    fn connect_menu_type_hint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_menu_type_hint_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::menu-type-hint\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_menu_type_hint_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "monitor")]
    fn connect_monitor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_monitor_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::monitor\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_monitor_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "rect-anchor-dx")]
    fn connect_rect_anchor_dx_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rect_anchor_dx_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::rect-anchor-dx\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_rect_anchor_dx_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "rect-anchor-dy")]
    fn connect_rect_anchor_dy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_rect_anchor_dy_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::rect-anchor-dy\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_rect_anchor_dy_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "reserve-toggle-size")]
    fn connect_reserve_toggle_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_reserve_toggle_size_trampoline<P: IsA<Menu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Menu::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::reserve-toggle-size\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_reserve_toggle_size_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
