...
use crate::{Adjustment,Align,Bin,Buildable,Container,ResizeMode,Scrollable,ScrollablePolicy,ShadowType,Widget};
...
impl Viewport {
    ...
    pub fn new(hadjustment: Option<&impl IsA<Adjustment>>, vadjustment: Option<&impl IsA<Adjustment>>) -> Viewport {
...
pub trait ViewportExt: IsA<Viewport> + sealed::Sealed + 'static {
    ...
    fn connect_shadow_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_shadow_type_trampoline<P: IsA<Viewport>, F: Fn(&P) + 'static>(this: *mut ffi::GtkViewport, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
