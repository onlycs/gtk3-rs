...
pub trait TreeSortableExt: IsA<TreeSortable> + sealed::Sealed + 'static {
    ...
    fn connect_sort_column_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn sort_column_changed_trampoline<P: IsA<TreeSortable>, F: Fn(&P) + 'static>(this: *mut ffi::GtkTreeSortable, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"sort-column-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(sort_column_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
