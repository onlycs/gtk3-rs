...
impl ShortcutLabel {
    ...
    pub fn new(accelerator: &str) -> ShortcutLabel {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_shortcut_label_new(accelerator.to_glib_none().0)).unsafe_cast()
        }
    }
    ...
    pub fn accelerator(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::gtk_shortcut_label_get_accelerator(self.to_glib_none().0))
        }
    }
    ...
    pub fn disabled_text(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::gtk_shortcut_label_get_disabled_text(self.to_glib_none().0))
        }
    }
    ...
    pub fn set_accelerator(&self, accelerator: &str) {
        unsafe {
            ffi::gtk_shortcut_label_set_accelerator(self.to_glib_none().0, accelerator.to_glib_none().0);
        }
    }
    ...
    pub fn set_disabled_text(&self, disabled_text: &str) {
        unsafe {
            ffi::gtk_shortcut_label_set_disabled_text(self.to_glib_none().0, disabled_text.to_glib_none().0);
        }
    }

    #[doc(alias = "accelerator")]
    pub fn connect_accelerator_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accelerator_trampoline<F: Fn(&ShortcutLabel) + 'static>(this: *mut ffi::GtkShortcutLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    pub fn connect_disabled_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_disabled_text_trampoline<F: Fn(&ShortcutLabel) + 'static>(this: *mut ffi::GtkShortcutLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::disabled-text\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_disabled_text_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
