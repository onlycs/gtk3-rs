...
use crate::{Adjustment,Align,Buildable,Container,ResizeMode,Scrollable,ScrollablePolicy,Widget};
...
impl Layout {
    ...
    pub fn new(hadjustment: Option<&impl IsA<Adjustment>>, vadjustment: Option<&impl IsA<Adjustment>>) -> Layout {
...
pub trait LayoutExt: IsA<Layout> + sealed::Sealed + 'static {
    ...
    fn size(&self) -> (u32, u32) {
        unsafe {
            ...
            ffi::gtk_layout_get_size(self.as_ref().to_glib_none().0, width.as_mut_ptr(), height.as_mut_ptr());
    ...
    fn child_x<T: IsA<crate::Widget>>(&self, item: &T) -> i32 {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"x")
    }

    fn set_child_x<T: IsA<crate::Widget>>(&self, item: &T, x: i32) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"x", &x)
    }

    fn child_y<T: IsA<crate::Widget>>(&self, item: &T) -> i32 {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"y")
    }

    fn set_child_y<T: IsA<crate::Widget>>(&self, item: &T, y: i32) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"y", &y)
    }

    #[doc(alias = "height")]
    fn connect_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<P: IsA<Layout>, F: Fn(&P) + 'static>(this: *mut ffi::GtkLayout, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<P: IsA<Layout>, F: Fn(&P) + 'static>(this: *mut ffi::GtkLayout, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Layout::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
