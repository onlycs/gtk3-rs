...
pub trait CellRendererComboExt: IsA<CellRendererCombo> + sealed::Sealed + 'static {
    ...
    fn connect_changed<F: Fn(&Self, TreePath, &TreeIter) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn changed_trampoline<P: IsA<CellRendererCombo>, F: Fn(&P, TreePath, &TreeIter) + 'static>(this: *mut ffi::GtkCellRendererCombo, path_string: *mut libc::c_char, new_iter: *mut ffi::GtkTreeIter, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            let path = from_glib_full(crate::ffi::gtk_tree_path_new_from_string(path_string));
            f(CellRendererCombo::from_glib_borrow(this).unsafe_cast_ref(), path, &from_glib_borrow(new_iter))
        }
        unsafe {
    ...
    fn connect_has_entry_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_has_entry_trampoline<P: IsA<CellRendererCombo>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererCombo, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::has-entry\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_has_entry_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "model")]
    fn connect_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_model_trampoline<P: IsA<CellRendererCombo>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererCombo, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererCombo::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_text_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_column_trampoline<P: IsA<CellRendererCombo>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererCombo, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererCombo::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
