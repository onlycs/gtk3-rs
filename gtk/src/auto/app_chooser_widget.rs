...
use crate::{Align,AppChooser,BaselinePosition,Box,Buildable,Container,Menu,Orientable,Orientation,ResizeMode,Widget};
...
pub struct AppChooserWidgetBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("default-text", default_text.into()), }
                        }

                            pub fn show_all(self, show_all: bool) -> Self {
                            Self { builder: self.builder.property("show-all", show_all), }
                        }

                            pub fn show_default(self, show_default: bool) -> Self {
                            Self { builder: self.builder.property("show-default", show_default), }
                        }

                            pub fn show_fallback(self, show_fallback: bool) -> Self {
                            Self { builder: self.builder.property("show-fallback", show_fallback), }
                        }

                            pub fn show_other(self, show_other: bool) -> Self {
                            Self { builder: self.builder.property("show-other", show_other), }
                        }

                            pub fn show_recommended(self, show_recommended: bool) -> Self {
                            Self { builder: self.builder.property("show-recommended", show_recommended), }
                        }
                            ...
                            Self { builder: self.builder.property("content-type", content_type.into()), }
                        }
...
pub trait AppChooserWidgetExt: IsA<AppChooserWidget> + sealed::Sealed + 'static {
    ...
    fn set_show_all(&self, setting: bool) {
        unsafe {
            ffi::gtk_app_chooser_widget_set_show_all(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }
    ...
    fn set_show_default(&self, setting: bool) {
        unsafe {
            ffi::gtk_app_chooser_widget_set_show_default(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }
    ...
    fn set_show_fallback(&self, setting: bool) {
        unsafe {
            ffi::gtk_app_chooser_widget_set_show_fallback(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }
    ...
    fn set_show_other(&self, setting: bool) {
        unsafe {
            ffi::gtk_app_chooser_widget_set_show_other(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }
    ...
    fn set_show_recommended(&self, setting: bool) {
        unsafe {
            ffi::gtk_app_chooser_widget_set_show_recommended(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }

    #[doc(alias = "application-activated")]
    fn connect_application_activated<F: Fn(&Self, &gio::AppInfo) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn application_activated_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P, &gio::AppInfo) + 'static>(this: *mut ffi::GtkAppChooserWidget, application: *mut gio::ffi::GAppInfo, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(application))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"application-activated\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(application_activated_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "application-selected")]
    fn connect_application_selected<F: Fn(&Self, &gio::AppInfo) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn application_selected_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P, &gio::AppInfo) + 'static>(this: *mut ffi::GtkAppChooserWidget, application: *mut gio::ffi::GAppInfo, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(application))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"application-selected\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(application_selected_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "populate-popup")]
    fn connect_populate_popup<F: Fn(&Self, &Menu, &gio::AppInfo) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn populate_popup_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P, &Menu, &gio::AppInfo) + 'static>(this: *mut ffi::GtkAppChooserWidget, menu: *mut ffi::GtkMenu, application: *mut gio::ffi::GAppInfo, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(menu), &from_glib_borrow(application))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_default_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_default_text_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::default-text\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_default_text_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-all")]
    fn connect_show_all_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_all_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-all\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_all_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-default")]
    fn connect_show_default_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_default_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-default\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_default_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-fallback")]
    fn connect_show_fallback_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_fallback_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-fallback\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_fallback_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-other")]
    fn connect_show_other_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_other_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-other\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_other_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-recommended")]
    fn connect_show_recommended_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_recommended_trampoline<P: IsA<AppChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserWidget::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-recommended\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_recommended_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
