...
use crate::{Actionable,Activatable,Align,Bin,Buildable,Container,RadioButton,ResizeMode,ToggleToolButton,ToolButton,ToolItem,Widget};
use glib::{prelude::*,translate::*};

glib::wrapper! {
    #[doc(alias = "GtkRadioToolButton")]
    pub struct RadioToolButton(Object<ffi::GtkRadioToolButton, ffi::GtkRadioToolButtonClass>) @extends ToggleToolButton, ToolButton, ToolItem, Bin, Container, Widget, @implements Buildable, Activatable, Actionable;
