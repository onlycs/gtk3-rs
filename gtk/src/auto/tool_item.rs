...
use crate::{Activatable,Align,Bin,Buildable,Container,IconSize,Orientation,ReliefStyle,ResizeMode,SizeGroup,ToolbarStyle,Widget};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_};

glib::wrapper! {
    #[doc(alias = "GtkToolItem")]
    pub struct ToolItem(Object<ffi::GtkToolItem, ffi::GtkToolItemClass>) @extends Bin, Container, Widget, @implements Buildable, Activatable;
...
pub trait ToolItemExt: IsA<ToolItem> + sealed::Sealed + 'static {
    ...
    fn set_homogeneous(&self, homogeneous: bool) {
        unsafe {
            ffi::gtk_tool_item_set_homogeneous(self.as_ref().to_glib_none().0, homogeneous.into_glib());
        }
    }
    ...
    fn set_is_important(&self, is_important: bool) {
        unsafe {
            ffi::gtk_tool_item_set_is_important(self.as_ref().to_glib_none().0, is_important.into_glib());
        }
    }
    ...
    fn set_tooltip_markup(&self, markup: &str) {
        unsafe {
            ffi::gtk_tool_item_set_tooltip_markup(self.as_ref().to_glib_none().0, markup.to_glib_none().0);
        }
    }
    ...
    fn set_tooltip_text(&self, text: &str) {
        unsafe {
            ffi::gtk_tool_item_set_tooltip_text(self.as_ref().to_glib_none().0, text.to_glib_none().0);
        }
    }
    ...
    fn set_use_drag_window(&self, use_drag_window: bool) {
        unsafe {
            ffi::gtk_tool_item_set_use_drag_window(self.as_ref().to_glib_none().0, use_drag_window.into_glib());
        }
    }
    ...
    fn set_visible_horizontal(&self, visible_horizontal: bool) {
        unsafe {
            ffi::gtk_tool_item_set_visible_horizontal(self.as_ref().to_glib_none().0, visible_horizontal.into_glib());
        }
    }
    ...
    fn set_visible_vertical(&self, visible_vertical: bool) {
        unsafe {
            ffi::gtk_tool_item_set_visible_vertical(self.as_ref().to_glib_none().0, visible_vertical.into_glib());
        }
    }
    ...
    fn connect_create_menu_proxy<F: Fn(&Self) -> glib::Propagation + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn create_menu_proxy_trampoline<P: IsA<ToolItem>, F: Fn(&P) -> glib::Propagation + 'static>(this: *mut ffi::GtkToolItem, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"create-menu-proxy\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(create_menu_proxy_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "toolbar-reconfigured")]
    fn connect_toolbar_reconfigured<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn toolbar_reconfigured_trampoline<P: IsA<ToolItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItem, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"toolbar-reconfigured\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(toolbar_reconfigured_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "is-important")]
    fn connect_is_important_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_is_important_trampoline<P: IsA<ToolItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolItem::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::is-important\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_is_important_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "visible-horizontal")]
    fn connect_visible_horizontal_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_visible_horizontal_trampoline<P: IsA<ToolItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolItem::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::visible-horizontal\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_visible_horizontal_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "visible-vertical")]
    fn connect_visible_vertical_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_visible_vertical_trampoline<P: IsA<ToolItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolItem::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::visible-vertical\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_visible_vertical_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
