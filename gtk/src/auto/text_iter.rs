...
impl TextIter {
    ...
    pub fn backward_find_char<P: FnMut(char) -> bool>(&mut self, pred: P, limit: Option<&TextIter>) -> bool {
        ...
        unsafe extern "C" fn pred_func<P: FnMut(char) -> bool>(ch: u32, user_data: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let ch = std::convert::TryFrom::try_from(ch).expect("conversion from an invalid Unicode value attempted");
    ...
    pub fn backward_search(&self, str: &str, flags: TextSearchFlags, limit: Option<&TextIter>) -> Option<(TextIter, TextIter)> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_text_iter_backward_search(self.to_glib_none().0, str.to_glib_none().0, flags.into_glib(), match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0, limit.to_glib_none().0));
    ...
    pub fn can_insert(&self, default_editability: bool) -> bool {
        unsafe {
            from_glib(ffi::gtk_text_iter_can_insert(self.to_glib_none().0, default_editability.into_glib()))
        }
    }
    ...
    pub fn editable(&self, default_setting: bool) -> bool {
        unsafe {
            from_glib(ffi::gtk_text_iter_editable(self.to_glib_none().0, default_setting.into_glib()))
        }
    }
    ...
    pub fn forward_search(&self, str: &str, flags: TextSearchFlags, limit: Option<&TextIter>) -> Option<(TextIter, TextIter)> {
        unsafe {
            let mut match_start = TextIter::uninitialized();
            let mut match_end = TextIter::uninitialized();
            let ret = from_glib(ffi::gtk_text_iter_forward_search(self.to_glib_none().0, str.to_glib_none().0, flags.into_glib(), match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0, limit.to_glib_none().0));
            if ret { Some((match_start, match_end)) } else { None }
        }
    }
    ...
    pub fn toggled_tags(&self, toggled_on: bool) -> Vec<TextTag> {
        unsafe {
            FromGlibPtrContainer::from_glib_container(ffi::gtk_text_iter_get_toggled_tags(self.to_glib_none().0, toggled_on.into_glib()))
        }
    }
