...
use crate::{Adjustment,Align,Buildable,CellEditable,Container,Editable,Entry,EntryBuffer,EntryCompletion,InputHints,InputPurpose,Orientable,Orientation,SpinButtonUpdatePolicy,SpinType,Widget};
...
pub struct SpinButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("climb-rate", climb_rate), }
                        }
                            ...
                            Self { builder: self.builder.property("numeric", numeric), }
                        }

                            pub fn snap_to_ticks(self, snap_to_ticks: bool) -> Self {
                            Self { builder: self.builder.property("snap-to-ticks", snap_to_ticks), }
                        }

                            pub fn update_policy(self, update_policy: SpinButtonUpdatePolicy) -> Self {
                            Self { builder: self.builder.property("update-policy", update_policy), }
                        }
...
pub trait SpinButtonExt: IsA<SpinButton> + sealed::Sealed + 'static {
    ...
    fn increments(&self) -> (f64, f64) {
        unsafe {
            ...
            ffi::gtk_spin_button_get_increments(self.as_ref().to_glib_none().0, step.as_mut_ptr(), page.as_mut_ptr());
    ...
    fn range(&self) -> (f64, f64) {
        unsafe {
            ...
            ffi::gtk_spin_button_get_range(self.as_ref().to_glib_none().0, min.as_mut_ptr(), max.as_mut_ptr());
    ...
    fn set_snap_to_ticks(&self, snap_to_ticks: bool) {
        unsafe {
            ffi::gtk_spin_button_set_snap_to_ticks(self.as_ref().to_glib_none().0, snap_to_ticks.into_glib());
        }
    }
    ...
    fn set_update_policy(&self, policy: SpinButtonUpdatePolicy) {
        unsafe {
            ffi::gtk_spin_button_set_update_policy(self.as_ref().to_glib_none().0, policy.into_glib());
        }
    }
    ...
    fn spin(&self, direction: SpinType, increment: f64) {
        unsafe {
            ffi::gtk_spin_button_spin(self.as_ref().to_glib_none().0, direction.into_glib(), increment);
        }
    }
    ...
    fn connect_adjustment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_adjustment_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_climb_rate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_climb_rate_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpinButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::climb-rate\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_climb_rate_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "digits")]
    fn connect_digits_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_digits_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpinButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::digits\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_digits_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "numeric")]
    fn connect_numeric_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_numeric_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpinButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::numeric\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_numeric_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "snap-to-ticks")]
    fn connect_snap_to_ticks_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_snap_to_ticks_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpinButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::snap-to-ticks\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_snap_to_ticks_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "update-policy")]
    fn connect_update_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_update_policy_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpinButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::update-policy\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_update_policy_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "value")]
    fn connect_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_value_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpinButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_wrap_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_wrap_trampoline<P: IsA<SpinButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkSpinButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(SpinButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
