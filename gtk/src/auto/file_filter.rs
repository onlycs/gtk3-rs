...
impl FileFilter {
    ...
    pub fn add_custom<P: Fn(&FileFilterInfo) -> bool + 'static>(&self, needed: FileFilterFlags, func: P) {
        ...
        unsafe extern "C" fn func_func<P: Fn(&FileFilterInfo) -> bool + 'static>(filter_info: *const ffi::GtkFileFilterInfo, data: glib::ffi::gpointer) -> glib::ffi::gboolean {
        ...
        unsafe extern "C" fn notify_func<P: Fn(&FileFilterInfo) -> bool + 'static>(data: glib::ffi::gpointer) {
            let _callback: Box_<P> = Box_::from_raw(data as *mut _);
        }
        let destroy_call4 = Some(notify_func::<P> as _);
        let super_callback0: Box_<P> = func_data;
        unsafe {
            ffi::gtk_file_filter_add_custom(self.to_glib_none().0, needed.into_glib(), func, Box_::into_raw(super_callback0) as *mut _, destroy_call4);
        }
    }
    ...
    pub fn filter(&self, filter_info: &FileFilterInfo) -> bool {
        unsafe {
            from_glib(ffi::gtk_file_filter_filter(self.to_glib_none().0, filter_info.to_glib_none().0))
        }
    }
