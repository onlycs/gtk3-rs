...
pub trait OrientableExt: IsA<Orientable> + sealed::Sealed + 'static {
    ...
    fn set_orientation(&self, orientation: Orientation) {
        unsafe {
            ffi::gtk_orientable_set_orientation(self.as_ref().to_glib_none().0, orientation.into_glib());
        }
    }

    #[doc(alias = "orientation")]
    fn connect_orientation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_orientation_trampoline<P: IsA<Orientable>, F: Fn(&P) + 'static>(this: *mut ffi::GtkOrientable, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::orientation\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_orientation_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
