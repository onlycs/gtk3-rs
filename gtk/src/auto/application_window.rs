...
use crate::{Align,Application,Bin,Buildable,Container,ResizeMode,ShortcutsWindow,Widget,Window,WindowPosition,WindowType};
...
pub trait ApplicationWindowExt: IsA<ApplicationWindow> + sealed::Sealed + 'static {
    ...
    fn set_show_menubar(&self, show_menubar: bool) {
        unsafe {
            ffi::gtk_application_window_set_show_menubar(self.as_ref().to_glib_none().0, show_menubar.into_glib());
        }
    }

    #[doc(alias = "show-menubar")]
    fn connect_show_menubar_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_menubar_trampoline<P: IsA<ApplicationWindow>, F: Fn(&P) + 'static>(this: *mut ffi::GtkApplicationWindow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-menubar\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_menubar_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
