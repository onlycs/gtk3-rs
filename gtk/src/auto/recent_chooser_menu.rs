...
use crate::{AccelGroup,Activatable,Align,Buildable,Container,Menu,MenuShell,RecentChooser,RecentFilter,RecentManager,RecentSortType,ResizeMode,Widget};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_};

glib::wrapper! {
    #[doc(alias = "GtkRecentChooserMenu")]
    pub struct RecentChooserMenu(Object<ffi::GtkRecentChooserMenu, ffi::GtkRecentChooserMenuClass>) @extends Menu, MenuShell, Container, Widget, @implements Buildable, Activatable, RecentChooser;
...
pub struct RecentChooserMenuBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("show-numbers", show_numbers), }
                        }
                            ...
                            Self { builder: self.builder.property("recent-manager", recent_manager.clone().upcast()), }
                        }
                            ...
                            Self { builder: self.builder.property("show-icons", show_icons), }
                        }

                            pub fn show_not_found(self, show_not_found: bool) -> Self {
                            Self { builder: self.builder.property("show-not-found", show_not_found), }
                        }

                            pub fn show_private(self, show_private: bool) -> Self {
                            Self { builder: self.builder.property("show-private", show_private), }
                        }

                            pub fn show_tips(self, show_tips: bool) -> Self {
                            Self { builder: self.builder.property("show-tips", show_tips), }
                        }

                            pub fn sort_type(self, sort_type: RecentSortType) -> Self {
                            Self { builder: self.builder.property("sort-type", sort_type), }
                        }
...
pub trait RecentChooserMenuExt: IsA<RecentChooserMenu> + sealed::Sealed + 'static {
    ...
    fn set_show_numbers(&self, show_numbers: bool) {
        unsafe {
            ffi::gtk_recent_chooser_menu_set_show_numbers(self.as_ref().to_glib_none().0, show_numbers.into_glib());
        }
    }

    #[doc(alias = "show-numbers")]
    fn connect_show_numbers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_numbers_trampoline<P: IsA<RecentChooserMenu>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooserMenu, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-numbers\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_numbers_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
