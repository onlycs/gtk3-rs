...
pub trait GestureExt: IsA<Gesture> + sealed::Sealed + 'static {
    ...
    fn bounding_box_center(&self) -> Option<(f64, f64)> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_gesture_get_bounding_box_center(self.as_ref().to_glib_none().0, x.as_mut_ptr(), y.as_mut_ptr()));
    ...
    fn point(&self, sequence: Option<&gdk::EventSequence>) -> Option<(f64, f64)> {
        unsafe {
            let mut x = std::mem::MaybeUninit::uninit();
            let mut y = std::mem::MaybeUninit::uninit();
            let ret = from_glib(ffi::gtk_gesture_get_point(self.as_ref().to_glib_none().0, mut_override(sequence.to_glib_none().0), x.as_mut_ptr(), y.as_mut_ptr()));
            if ret { Some((x.assume_init(), y.assume_init())) } else { None }
        }
    }
    ...
    fn set_sequence_state(&self, sequence: &gdk::EventSequence, state: EventSequenceState) -> bool {
        unsafe {
            from_glib(ffi::gtk_gesture_set_sequence_state(self.as_ref().to_glib_none().0, mut_override(sequence.to_glib_none().0), state.into_glib()))
        }
    }
    ...
    fn set_state(&self, state: EventSequenceState) -> bool {
        unsafe {
            from_glib(ffi::gtk_gesture_set_state(self.as_ref().to_glib_none().0, state.into_glib()))
        }
    }
    ...
    #[doc(alias = "begin")]
    fn connect_begin<F: Fn(&Self, Option<&gdk::EventSequence>) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn begin_trampoline<P: IsA<Gesture>, F: Fn(&P, Option<&gdk::EventSequence>) + 'static>(this: *mut ffi::GtkGesture, sequence: *mut gdk::ffi::GdkEventSequence, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Gesture::from_glib_borrow(this).unsafe_cast_ref(), Option::<gdk::EventSequence>::from_glib_borrow(sequence).as_ref().as_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"begin\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(begin_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "cancel")]
    fn connect_cancel<F: Fn(&Self, Option<&gdk::EventSequence>) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn cancel_trampoline<P: IsA<Gesture>, F: Fn(&P, Option<&gdk::EventSequence>) + 'static>(this: *mut ffi::GtkGesture, sequence: *mut gdk::ffi::GdkEventSequence, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Gesture::from_glib_borrow(this).unsafe_cast_ref(), Option::<gdk::EventSequence>::from_glib_borrow(sequence).as_ref().as_ref())
        }
        unsafe {
    ...
    #[doc(alias = "end")]
    fn connect_end<F: Fn(&Self, Option<&gdk::EventSequence>) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn end_trampoline<P: IsA<Gesture>, F: Fn(&P, Option<&gdk::EventSequence>) + 'static>(this: *mut ffi::GtkGesture, sequence: *mut gdk::ffi::GdkEventSequence, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Gesture::from_glib_borrow(this).unsafe_cast_ref(), Option::<gdk::EventSequence>::from_glib_borrow(sequence).as_ref().as_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"end\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(end_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "sequence-state-changed")]
    fn connect_sequence_state_changed<F: Fn(&Self, Option<&gdk::EventSequence>, EventSequenceState) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn sequence_state_changed_trampoline<P: IsA<Gesture>, F: Fn(&P, Option<&gdk::EventSequence>, EventSequenceState) + 'static>(this: *mut ffi::GtkGesture, sequence: *mut gdk::ffi::GdkEventSequence, state: ffi::GtkEventSequenceState, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Gesture::from_glib_borrow(this).unsafe_cast_ref(), Option::<gdk::EventSequence>::from_glib_borrow(sequence).as_ref().as_ref(), from_glib(state))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"sequence-state-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(sequence_state_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "update")]
    fn connect_update<F: Fn(&Self, Option<&gdk::EventSequence>) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn update_trampoline<P: IsA<Gesture>, F: Fn(&P, Option<&gdk::EventSequence>) + 'static>(this: *mut ffi::GtkGesture, sequence: *mut gdk::ffi::GdkEventSequence, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Gesture::from_glib_borrow(this).unsafe_cast_ref(), Option::<gdk::EventSequence>::from_glib_borrow(sequence).as_ref().as_ref())
        }
        unsafe {
    ...
    fn connect_window_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_window_trampoline<P: IsA<Gesture>, F: Fn(&P) + 'static>(this: *mut ffi::GtkGesture, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
