...
pub struct CellRendererAccelBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("accel-key", accel_key), }
                        }

                            pub fn accel_mode(self, accel_mode: CellRendererAccelMode) -> Self {
                            Self { builder: self.builder.property("accel-mode", accel_mode), }
                        }

                            pub fn accel_mods(self, accel_mods: gdk::ModifierType) -> Self {
                            Self { builder: self.builder.property("accel-mods", accel_mods), }
                        }
...
pub trait CellRendererAccelExt: IsA<CellRendererAccel> + sealed::Sealed + 'static {
    ...
    fn connect_accel_cleared<F: Fn(&Self, TreePath) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn accel_cleared_trampoline<P: IsA<CellRendererAccel>, F: Fn(&P, TreePath) + 'static>(this: *mut ffi::GtkCellRendererAccel, path_string: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            let path = from_glib_full(crate::ffi::gtk_tree_path_new_from_string(path_string));
            f(CellRendererAccel::from_glib_borrow(this).unsafe_cast_ref(), path)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"accel-cleared\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(accel_cleared_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_accel_edited<F: Fn(&Self, TreePath, u32, gdk::ModifierType, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn accel_edited_trampoline<P: IsA<CellRendererAccel>, F: Fn(&P, TreePath, u32, gdk::ModifierType, u32) + 'static>(this: *mut ffi::GtkCellRendererAccel, path_string: *mut libc::c_char, accel_key: libc::c_uint, accel_mods: gdk::ffi::GdkModifierType, hardware_keycode: libc::c_uint, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            let path = from_glib_full(crate::ffi::gtk_tree_path_new_from_string(path_string));
            f(CellRendererAccel::from_glib_borrow(this).unsafe_cast_ref(), path, accel_key, from_glib(accel_mods), hardware_keycode)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"accel-edited\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(accel_edited_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accel-key")]
    fn connect_accel_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_key_trampoline<P: IsA<CellRendererAccel>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererAccel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-key\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_accel_key_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accel-mode")]
    fn connect_accel_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_mode_trampoline<P: IsA<CellRendererAccel>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererAccel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererAccel::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-mode\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_accel_mode_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accel-mods")]
    fn connect_accel_mods_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_mods_trampoline<P: IsA<CellRendererAccel>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererAccel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererAccel::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-mods\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_accel_mods_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "keycode")]
    fn connect_keycode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_keycode_trampoline<P: IsA<CellRendererAccel>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellRendererAccel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellRendererAccel::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::keycode\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_keycode_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
