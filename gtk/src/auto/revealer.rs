...
pub struct RevealerBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("reveal-child", reveal_child), }
                        }
...
pub trait RevealerExt: IsA<Revealer> + sealed::Sealed + 'static {
    ...
    fn set_reveal_child(&self, reveal_child: bool) {
        unsafe {
            ffi::gtk_revealer_set_reveal_child(self.as_ref().to_glib_none().0, reveal_child.into_glib());
        }
    }
    ...
    fn set_transition_type(&self, transition: RevealerTransitionType) {
        unsafe {
            ffi::gtk_revealer_set_transition_type(self.as_ref().to_glib_none().0, transition.into_glib());
        }
    }

    #[doc(alias = "child-revealed")]
    fn connect_child_revealed_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_revealed_trampoline<P: IsA<Revealer>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRevealer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::child-revealed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_child_revealed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "reveal-child")]
    fn connect_reveal_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_reveal_child_trampoline<P: IsA<Revealer>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRevealer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Revealer::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::reveal-child\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_reveal_child_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "transition-duration")]
    fn connect_transition_duration_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_transition_duration_trampoline<P: IsA<Revealer>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRevealer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Revealer::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_transition_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_transition_type_trampoline<P: IsA<Revealer>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRevealer, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Revealer::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
