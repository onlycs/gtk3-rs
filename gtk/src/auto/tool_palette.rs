...
use crate::{Adjustment,Align,Buildable,Container,DestDefaults,IconSize,Orientable,Orientation,ResizeMode,Scrollable,ScrollablePolicy,SelectionData,TargetEntry,ToolItem,ToolItemGroup,ToolPaletteDragTargets,ToolbarStyle,Widget};
...
pub trait ToolPaletteExt: IsA<ToolPalette> + sealed::Sealed + 'static {
    ...
    fn add_drag_dest(&self, widget: &impl IsA<Widget>, flags: DestDefaults, targets: ToolPaletteDragTargets, actions: gdk::DragAction) {
        unsafe {
            ffi::gtk_tool_palette_add_drag_dest(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, flags.into_glib(), targets.into_glib(), actions.into_glib());
        }
    }
    ...
    fn set_drag_source(&self, targets: ToolPaletteDragTargets) {
        unsafe {
            ffi::gtk_tool_palette_set_drag_source(self.as_ref().to_glib_none().0, targets.into_glib());
        }
    }
    ...
    fn set_exclusive(&self, group: &impl IsA<ToolItemGroup>, exclusive: bool) {
        unsafe {
            ffi::gtk_tool_palette_set_exclusive(self.as_ref().to_glib_none().0, group.as_ref().to_glib_none().0, exclusive.into_glib());
        }
    }
    ...
    fn set_expand(&self, group: &impl IsA<ToolItemGroup>, expand: bool) {
        unsafe {
            ffi::gtk_tool_palette_set_expand(self.as_ref().to_glib_none().0, group.as_ref().to_glib_none().0, expand.into_glib());
        }
    }
    ...
    fn set_icon_size(&self, icon_size: IconSize) {
        unsafe {
            ffi::gtk_tool_palette_set_icon_size(self.as_ref().to_glib_none().0, icon_size.into_glib());
        }
    }
    ...
    fn connect_icon_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_size_trampoline<P: IsA<ToolPalette>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolPalette, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
    ...
    fn connect_icon_size_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_icon_size_set_trampoline<P: IsA<ToolPalette>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolPalette, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolPalette::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_toolbar_style_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_toolbar_style_trampoline<P: IsA<ToolPalette>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolPalette, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolPalette::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
