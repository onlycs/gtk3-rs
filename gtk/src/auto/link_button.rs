...
glib::wrapper! {
    ...
    pub struct LinkButton(Object<ffi::GtkLinkButton, ffi::GtkLinkButtonClass>) @extends Button, Bin, Container, Widget, @implements Buildable, Actionable, Activatable;
...
pub struct LinkButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("visited", visited), }
                        }
...
pub trait LinkButtonExt: IsA<LinkButton> + sealed::Sealed + 'static {
    ...
    fn connect_activate_link<F: Fn(&Self) -> glib::Propagation + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activate_link_trampoline<P: IsA<LinkButton>, F: Fn(&P) -> glib::Propagation + 'static>(this: *mut ffi::GtkLinkButton, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
    ...
    fn connect_uri_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_uri_trampoline<P: IsA<LinkButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkLinkButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
    ...
    fn connect_visited_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_visited_trampoline<P: IsA<LinkButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkLinkButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(LinkButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::visited\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_visited_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
