...
pub struct StackSidebarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("stack", stack.clone().upcast()), }
                        }
...
pub trait StackSidebarExt: IsA<StackSidebar> + sealed::Sealed + 'static {
    ...
    fn connect_stack_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stack_trampoline<P: IsA<StackSidebar>, F: Fn(&P) + 'static>(this: *mut ffi::GtkStackSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
