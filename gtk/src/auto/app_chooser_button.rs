...
use crate::{Align,AppChooser,Bin,Buildable,CellArea,CellEditable,CellLayout,ComboBox,Container,ResizeMode,SensitivityType,TreeModel,Widget};
...
pub struct AppChooserButtonBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("heading", heading.into()), }
                        }

                            pub fn show_default_item(self, show_default_item: bool) -> Self {
                            Self { builder: self.builder.property("show-default-item", show_default_item), }
                        }

                            pub fn show_dialog_item(self, show_dialog_item: bool) -> Self {
                            Self { builder: self.builder.property("show-dialog-item", show_dialog_item), }
                        }
...
pub trait AppChooserButtonExt: IsA<AppChooserButton> + sealed::Sealed + 'static {
    ...
    fn set_show_default_item(&self, setting: bool) {
        unsafe {
            ffi::gtk_app_chooser_button_set_show_default_item(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }
    ...
    fn set_show_dialog_item(&self, setting: bool) {
        unsafe {
            ffi::gtk_app_chooser_button_set_show_dialog_item(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }
    ...
    fn connect_custom_item_activated<F: Fn(&Self, &str) + 'static>(&self, detail: Option<&str>, f: F) -> SignalHandlerId {
        unsafe extern "C" fn custom_item_activated_trampoline<P: IsA<AppChooserButton>, F: Fn(&P, &str) + 'static>(this: *mut ffi::GtkAppChooserButton, item_name: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserButton::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(item_name))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            let detailed_signal_name = detail.map(|name| { format!("custom-item-activated::{name}\0") });
            let signal_name: &[u8] = detailed_signal_name.as_ref().map_or(&b"custom-item-activated\0"[..], |n| n.as_bytes());
            connect_raw(self.as_ptr() as *mut _, signal_name.as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(custom_item_activated_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "heading")]
    fn connect_heading_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_heading_trampoline<P: IsA<AppChooserButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::heading\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_heading_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-default-item")]
    fn connect_show_default_item_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_default_item_trampoline<P: IsA<AppChooserButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-default-item\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_default_item_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-dialog-item")]
    fn connect_show_dialog_item_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_dialog_item_trampoline<P: IsA<AppChooserButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAppChooserButton, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AppChooserButton::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-dialog-item\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_dialog_item_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
