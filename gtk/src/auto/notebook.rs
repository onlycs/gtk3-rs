...
use crate::{Align,Buildable,Container,DirectionType,NotebookTab,PackType,PositionType,ResizeMode,Widget};
...
pub struct NotebookBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("enable-popup", enable_popup), }
                        }

                            pub fn group_name(self, group_name: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("group-name", group_name.into()), }
                        }
                            ...
                            Self { builder: self.builder.property("scrollable", scrollable), }
                        }

                            pub fn show_border(self, show_border: bool) -> Self {
                            Self { builder: self.builder.property("show-border", show_border), }
                        }

                            pub fn show_tabs(self, show_tabs: bool) -> Self {
                            Self { builder: self.builder.property("show-tabs", show_tabs), }
                        }

                            pub fn tab_pos(self, tab_pos: PositionType) -> Self {
                            Self { builder: self.builder.property("tab-pos", tab_pos), }
                        }
...
pub trait NotebookExt: IsA<Notebook> + sealed::Sealed + 'static {
    ...
    fn action_widget(&self, pack_type: PackType) -> Option<Widget> {
        unsafe {
            from_glib_none(ffi::gtk_notebook_get_action_widget(self.as_ref().to_glib_none().0, pack_type.into_glib()))
        }
    }
    ...
    fn set_action_widget(&self, widget: &impl IsA<Widget>, pack_type: PackType) {
        unsafe {
            ffi::gtk_notebook_set_action_widget(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, pack_type.into_glib());
        }
    }
    ...
    fn set_scrollable(&self, scrollable: bool) {
        unsafe {
            ffi::gtk_notebook_set_scrollable(self.as_ref().to_glib_none().0, scrollable.into_glib());
        }
    }
    ...
    fn set_show_border(&self, show_border: bool) {
        unsafe {
            ffi::gtk_notebook_set_show_border(self.as_ref().to_glib_none().0, show_border.into_glib());
        }
    }
    ...
    fn set_tab_detachable(&self, child: &impl IsA<Widget>, detachable: bool) {
        unsafe {
            ffi::gtk_notebook_set_tab_detachable(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, detachable.into_glib());
        }
    }
    ...
    fn set_tab_reorderable(&self, child: &impl IsA<Widget>, reorderable: bool) {
        unsafe {
            ffi::gtk_notebook_set_tab_reorderable(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, reorderable.into_glib());
        }
    }
    ...
    fn child_is_detachable<T: IsA<crate::Widget>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"detachable")
    }

    fn set_child_detachable<T: IsA<crate::Widget>>(&self, item: &T, detachable: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"detachable", &detachable)
    }

    #[doc(alias = "child.menu-label")]
    fn child_menu_label<T: IsA<crate::Widget>>(&self, item: &T) -> Option<glib::GString> {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"menu-label")
    }

    #[doc(alias = "child.menu-label")]
    fn set_child_menu_label<T: IsA<crate::Widget>>(&self, item: &T, menu_label: Option<&str>) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"menu-label", &menu_label)
    }

    fn child_position<T: IsA<crate::Widget>>(&self, item: &T) -> i32 {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"position")
    }

    fn set_child_position<T: IsA<crate::Widget>>(&self, item: &T, position: i32) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"position", &position)
    }

    fn child_is_reorderable<T: IsA<crate::Widget>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"reorderable")
    }

    fn set_child_reorderable<T: IsA<crate::Widget>>(&self, item: &T, reorderable: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"reorderable", &reorderable)
    }

    #[doc(alias = "child.tab-expand")]
    fn child_tab_expands<T: IsA<crate::Widget>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"tab-expand")
    }

    #[doc(alias = "child.tab-expand")]
    fn set_child_tab_expand<T: IsA<crate::Widget>>(&self, item: &T, tab_expand: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"tab-expand", &tab_expand)
    }

    #[doc(alias = "child.tab-fill")]
    fn child_tab_fills<T: IsA<crate::Widget>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"tab-fill")
    }

    #[doc(alias = "child.tab-fill")]
    fn set_child_tab_fill<T: IsA<crate::Widget>>(&self, item: &T, tab_fill: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"tab-fill", &tab_fill)
    }

    #[doc(alias = "child.tab-label")]
    fn child_tab_label<T: IsA<crate::Widget>>(&self, item: &T) -> Option<glib::GString> {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"tab-label")
    }

    #[doc(alias = "child.tab-label")]
    fn set_child_tab_label<T: IsA<crate::Widget>>(&self, item: &T, tab_label: Option<&str>) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"tab-label", &tab_label)
    }

    #[doc(alias = "change-current-page")]
    fn connect_change_current_page<F: Fn(&Self, i32) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn change_current_page_trampoline<P: IsA<Notebook>, F: Fn(&P, i32) -> bool + 'static>(this: *mut ffi::GtkNotebook, object: libc::c_int, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"change-current-page\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(change_current_page_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_create_window<F: Fn(&Self, &Widget, i32, i32) -> Notebook + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn create_window_trampoline<P: IsA<Notebook>, F: Fn(&P, &Widget, i32, i32) -> Notebook + 'static>(this: *mut ffi::GtkNotebook, page: *mut ffi::GtkWidget, x: libc::c_int, y: libc::c_int, f: glib::ffi::gpointer) -> *mut ffi::GtkNotebook {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(page), x, y)/*Not checked*/.to_glib_none().0
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"create-window\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(create_window_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "focus-tab")]
    fn connect_focus_tab<F: Fn(&Self, NotebookTab) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn focus_tab_trampoline<P: IsA<Notebook>, F: Fn(&P, NotebookTab) -> bool + 'static>(this: *mut ffi::GtkNotebook, object: ffi::GtkNotebookTab, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), from_glib(object)).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"focus-tab\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(focus_tab_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_move_focus_out<F: Fn(&Self, DirectionType) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn move_focus_out_trampoline<P: IsA<Notebook>, F: Fn(&P, DirectionType) + 'static>(this: *mut ffi::GtkNotebook, object: ffi::GtkDirectionType, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), from_glib(object))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"move-focus-out\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(move_focus_out_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_page_added<F: Fn(&Self, &Widget, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn page_added_trampoline<P: IsA<Notebook>, F: Fn(&P, &Widget, u32) + 'static>(this: *mut ffi::GtkNotebook, child: *mut ffi::GtkWidget, page_num: libc::c_uint, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(child), page_num)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"page-added\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(page_added_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "page-removed")]
    fn connect_page_removed<F: Fn(&Self, &Widget, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn page_removed_trampoline<P: IsA<Notebook>, F: Fn(&P, &Widget, u32) + 'static>(this: *mut ffi::GtkNotebook, child: *mut ffi::GtkWidget, page_num: libc::c_uint, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(child), page_num)
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"page-removed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(page_removed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "page-reordered")]
    fn connect_page_reordered<F: Fn(&Self, &Widget, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn page_reordered_trampoline<P: IsA<Notebook>, F: Fn(&P, &Widget, u32) + 'static>(this: *mut ffi::GtkNotebook, child: *mut ffi::GtkWidget, page_num: libc::c_uint, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(child), page_num)
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"page-reordered\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(page_reordered_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "reorder-tab")]
    fn connect_reorder_tab<F: Fn(&Self, DirectionType, bool) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn reorder_tab_trampoline<P: IsA<Notebook>, F: Fn(&P, DirectionType, bool) -> bool + 'static>(this: *mut ffi::GtkNotebook, object: ffi::GtkDirectionType, p0: glib::ffi::gboolean, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), from_glib(object), from_glib(p0)).into_glib()
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"reorder-tab\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(reorder_tab_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_select_page<F: Fn(&Self, bool) -> bool + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn select_page_trampoline<P: IsA<Notebook>, F: Fn(&P, bool) -> bool + 'static>(this: *mut ffi::GtkNotebook, object: glib::ffi::gboolean, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), from_glib(object)).into_glib()
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"select-page\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(select_page_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_switch_page<F: Fn(&Self, &Widget, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn switch_page_trampoline<P: IsA<Notebook>, F: Fn(&P, &Widget, u32) + 'static>(this: *mut ffi::GtkNotebook, page: *mut ffi::GtkWidget, page_num: libc::c_uint, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(page), page_num)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"switch-page\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(switch_page_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "enable-popup")]
    fn connect_enable_popup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_enable_popup_trampoline<P: IsA<Notebook>, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::enable-popup\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_enable_popup_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "group-name")]
    fn connect_group_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_group_name_trampoline<P: IsA<Notebook>, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::group-name\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_group_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "page")]
    fn connect_page_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_page_trampoline<P: IsA<Notebook>, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_scrollable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_scrollable_trampoline<P: IsA<Notebook>, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::scrollable\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_scrollable_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-border")]
    fn connect_show_border_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_border_trampoline<P: IsA<Notebook>, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-border\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_border_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-tabs")]
    fn connect_show_tabs_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_tabs_trampoline<P: IsA<Notebook>, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-tabs\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_tabs_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "tab-pos")]
    fn connect_tab_pos_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_tab_pos_trampoline<P: IsA<Notebook>, F: Fn(&P) + 'static>(this: *mut ffi::GtkNotebook, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Notebook::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::tab-pos\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_tab_pos_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
