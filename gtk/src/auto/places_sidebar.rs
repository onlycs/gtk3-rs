...
use crate::{Adjustment,Align,Bin,Buildable,Container,CornerType,PlacesOpenFlags,PolicyType,ResizeMode,ScrolledWindow,ShadowType,Widget};
...
impl PlacesSidebar {
    ...
    pub fn add_shortcut(&self, location: &impl IsA<gio::File>) {
        unsafe {
            ffi::gtk_places_sidebar_add_shortcut(self.to_glib_none().0, location.as_ref().to_glib_none().0);
        }
    }
    ...
    pub fn remove_shortcut(&self, location: &impl IsA<gio::File>) {
        unsafe {
            ffi::gtk_places_sidebar_remove_shortcut(self.to_glib_none().0, location.as_ref().to_glib_none().0);
        }
    }
    ...
    pub fn set_drop_targets_visible(&self, visible: bool, context: &gdk::DragContext) {
        unsafe {
            ffi::gtk_places_sidebar_set_drop_targets_visible(self.to_glib_none().0, visible.into_glib(), context.to_glib_none().0);
        }
    }
    ...
    pub fn set_location(&self, location: Option<&impl IsA<gio::File>>) {
        unsafe {
            ffi::gtk_places_sidebar_set_location(self.to_glib_none().0, location.map(|p| p.as_ref()).to_glib_none().0);
        }
    }
    ...
    pub fn set_show_desktop(&self, show_desktop: bool) {
        unsafe {
            ffi::gtk_places_sidebar_set_show_desktop(self.to_glib_none().0, show_desktop.into_glib());
        }
    }
    ...
    pub fn set_show_enter_location(&self, show_enter_location: bool) {
        unsafe {
            ffi::gtk_places_sidebar_set_show_enter_location(self.to_glib_none().0, show_enter_location.into_glib());
        }
    }
    ...
    pub fn set_show_other_locations(&self, show_other_locations: bool) {
        unsafe {
            ffi::gtk_places_sidebar_set_show_other_locations(self.to_glib_none().0, show_other_locations.into_glib());
        }
    }
    ...
    pub fn set_show_starred_location(&self, show_starred_location: bool) {
        unsafe {
            ffi::gtk_places_sidebar_set_show_starred_location(self.to_glib_none().0, show_starred_location.into_glib());
        }
    }
    ...
    pub fn connect_drag_action_ask<F: Fn(&Self, i32) -> i32 + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn drag_action_ask_trampoline<F: Fn(&PlacesSidebar, i32) -> i32 + 'static>(this: *mut ffi::GtkPlacesSidebar, actions: libc::c_int, f: glib::ffi::gpointer) -> libc::c_int {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"drag-action-ask\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(drag_action_ask_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "mount")]
    pub fn connect_mount<F: Fn(&Self, &gio::MountOperation) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn mount_trampoline<F: Fn(&PlacesSidebar, &gio::MountOperation) + 'static>(this: *mut ffi::GtkPlacesSidebar, mount_operation: *mut gio::ffi::GMountOperation, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"mount\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(mount_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "open-location")]
    pub fn connect_open_location<F: Fn(&Self, &gio::File, PlacesOpenFlags) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn open_location_trampoline<F: Fn(&PlacesSidebar, &gio::File, PlacesOpenFlags) + 'static>(this: *mut ffi::GtkPlacesSidebar, location: *mut gio::ffi::GFile, open_flags: ffi::GtkPlacesOpenFlags, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"open-location\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(open_location_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_show_enter_location<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_enter_location_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"show-enter-location\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(show_enter_location_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-error-message")]
    pub fn connect_show_error_message<F: Fn(&Self, &str, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_error_message_trampoline<F: Fn(&PlacesSidebar, &str, &str) + 'static>(this: *mut ffi::GtkPlacesSidebar, primary: *mut libc::c_char, secondary: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this), &glib::GString::from_glib_borrow(primary), &glib::GString::from_glib_borrow(secondary))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"show-error-message\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(show_error_message_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-other-locations-with-flags")]
    pub fn connect_show_other_locations_with_flags<F: Fn(&Self, PlacesOpenFlags) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_other_locations_with_flags_trampoline<F: Fn(&PlacesSidebar, PlacesOpenFlags) + 'static>(this: *mut ffi::GtkPlacesSidebar, open_flags: ffi::GtkPlacesOpenFlags, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"show-other-locations-with-flags\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(show_other_locations_with_flags_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-starred-location")]
    pub fn connect_show_starred_location<F: Fn(&Self, PlacesOpenFlags) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn show_starred_location_trampoline<F: Fn(&PlacesSidebar, PlacesOpenFlags) + 'static>(this: *mut ffi::GtkPlacesSidebar, open_flags: ffi::GtkPlacesOpenFlags, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this), from_glib(open_flags))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"show-starred-location\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(show_starred_location_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "unmount")]
    pub fn connect_unmount<F: Fn(&Self, &gio::MountOperation) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn unmount_trampoline<F: Fn(&PlacesSidebar, &gio::MountOperation) + 'static>(this: *mut ffi::GtkPlacesSidebar, mount_operation: *mut gio::ffi::GMountOperation, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this), &from_glib_borrow(mount_operation))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"unmount\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(unmount_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "local-only")]
    pub fn connect_local_only_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_local_only_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::local-only\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_local_only_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "location")]
    pub fn connect_location_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_location_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::location\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_location_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "open-flags")]
    pub fn connect_open_flags_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_open_flags_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::open-flags\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_open_flags_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "populate-all")]
    pub fn connect_populate_all_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_populate_all_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::populate-all\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_populate_all_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-connect-to-server")]
    pub fn connect_show_connect_to_server_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_connect_to_server_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-connect-to-server\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_connect_to_server_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-desktop")]
    pub fn connect_show_desktop_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_desktop_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-desktop\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_desktop_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-enter-location")]
    pub fn connect_show_enter_location_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_enter_location_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-enter-location\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_enter_location_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-other-locations")]
    pub fn connect_show_other_locations_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_other_locations_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-other-locations\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_other_locations_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-recent")]
    pub fn connect_show_recent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_recent_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-recent\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_recent_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-starred-location")]
    pub fn connect_show_starred_location_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_starred_location_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-starred-location\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_starred_location_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-trash")]
    pub fn connect_show_trash_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_trash_trampoline<F: Fn(&PlacesSidebar) + 'static>(this: *mut ffi::GtkPlacesSidebar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-trash\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_trash_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
...
pub struct PlacesSidebarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("local-only", local_only), }
                        }

                            pub fn location(self, location: &impl IsA<gio::File>) -> Self {
                            Self { builder: self.builder.property("location", location.clone().upcast()), }
                        }

                            pub fn open_flags(self, open_flags: PlacesOpenFlags) -> Self {
                            Self { builder: self.builder.property("open-flags", open_flags), }
                        }
                            ...
                            Self { builder: self.builder.property("show-connect-to-server", show_connect_to_server), }
                        }

                            pub fn show_desktop(self, show_desktop: bool) -> Self {
                            Self { builder: self.builder.property("show-desktop", show_desktop), }
                        }

                            pub fn show_enter_location(self, show_enter_location: bool) -> Self {
                            Self { builder: self.builder.property("show-enter-location", show_enter_location), }
                        }

                            pub fn show_other_locations(self, show_other_locations: bool) -> Self {
                            Self { builder: self.builder.property("show-other-locations", show_other_locations), }
                        }

                            pub fn show_recent(self, show_recent: bool) -> Self {
                            Self { builder: self.builder.property("show-recent", show_recent), }
                        }

                            pub fn show_starred_location(self, show_starred_location: bool) -> Self {
                            Self { builder: self.builder.property("show-starred-location", show_starred_location), }
                        }

                            pub fn show_trash(self, show_trash: bool) -> Self {
                            Self { builder: self.builder.property("show-trash", show_trash), }
                        }
