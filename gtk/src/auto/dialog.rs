...
use crate::{Align,Application,Bin,Box,Buildable,Container,HeaderBar,ResizeMode,ResponseType,Widget,Window,WindowPosition,WindowType};
...
pub trait DialogExt: IsA<Dialog> + sealed::Sealed + 'static {
    ...
    fn add_action_widget(&self, child: &impl IsA<Widget>, response_id: ResponseType) {
        unsafe {
            ffi::gtk_dialog_add_action_widget(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, response_id.into_glib());
        }
    }
    ...
    fn add_button(&self, button_text: &str, response_id: ResponseType) -> Widget {
        unsafe {
            from_glib_none(ffi::gtk_dialog_add_button(self.as_ref().to_glib_none().0, button_text.to_glib_none().0, response_id.into_glib()))
        }
    }
    ...
    fn widget_for_response(&self, response_id: ResponseType) -> Option<Widget> {
        unsafe {
            from_glib_none(ffi::gtk_dialog_get_widget_for_response(self.as_ref().to_glib_none().0, response_id.into_glib()))
        }
    }
    ...
    fn set_default_response(&self, response_id: ResponseType) {
        unsafe {
            ffi::gtk_dialog_set_default_response(self.as_ref().to_glib_none().0, response_id.into_glib());
        }
    }
    ...
    fn set_response_sensitive(&self, response_id: ResponseType, setting: bool) {
        unsafe {
            ffi::gtk_dialog_set_response_sensitive(self.as_ref().to_glib_none().0, response_id.into_glib(), setting.into_glib());
        }
    }
    ...
    fn connect_close<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn close_trampoline<P: IsA<Dialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkDialog, f: glib::ffi::gpointer) {
    ...
    fn connect_response<F: Fn(&Self, ResponseType) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn response_trampoline<P: IsA<Dialog>, F: Fn(&P, ResponseType) + 'static>(this: *mut ffi::GtkDialog, response_id: ffi::GtkResponseType, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Dialog::from_glib_borrow(this).unsafe_cast_ref(), from_glib(response_id))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
