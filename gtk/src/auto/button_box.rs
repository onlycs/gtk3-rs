...
use crate::{Align,BaselinePosition,Box,Buildable,ButtonBoxStyle,Container,Orientable,Orientation,ResizeMode,Widget};
...
pub struct ButtonBoxBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("layout-style", layout_style), }
                        }
...
pub trait ButtonBoxExt: IsA<ButtonBox> + sealed::Sealed + 'static {
    ...
    fn set_child_non_homogeneous(&self, child: &impl IsA<Widget>, non_homogeneous: bool) {
        unsafe {
            ffi::gtk_button_box_set_child_non_homogeneous(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, non_homogeneous.into_glib());
        }
    }
    ...
    fn set_child_secondary(&self, child: &impl IsA<Widget>, is_secondary: bool) {
        unsafe {
            ffi::gtk_button_box_set_child_secondary(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, is_secondary.into_glib());
        }
    }
    ...
    fn set_layout(&self, layout_style: ButtonBoxStyle) {
        unsafe {
            ffi::gtk_button_box_set_layout(self.as_ref().to_glib_none().0, layout_style.into_glib());
        }
    }
    ...
    fn connect_layout_style_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_layout_style_trampoline<P: IsA<ButtonBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkButtonBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::layout-style\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_layout_style_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
