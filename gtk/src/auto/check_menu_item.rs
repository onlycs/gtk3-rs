...
use crate::{Actionable,Activatable,Align,Bin,Buildable,Container,Menu,MenuItem,ResizeMode,Widget};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_};

glib::wrapper! {
    #[doc(alias = "GtkCheckMenuItem")]
    pub struct CheckMenuItem(Object<ffi::GtkCheckMenuItem, ffi::GtkCheckMenuItemClass>) @extends MenuItem, Bin, Container, Widget, @implements Buildable, Actionable, Activatable;
...
pub trait CheckMenuItemExt: IsA<CheckMenuItem> + sealed::Sealed + 'static {
    ...
    fn set_active(&self, is_active: bool) {
        unsafe {
            ffi::gtk_check_menu_item_set_active(self.as_ref().to_glib_none().0, is_active.into_glib());
        }
    }
    ...
    fn set_draw_as_radio(&self, draw_as_radio: bool) {
        unsafe {
            ffi::gtk_check_menu_item_set_draw_as_radio(self.as_ref().to_glib_none().0, draw_as_radio.into_glib());
        }
    }
    ...
    fn set_inconsistent(&self, setting: bool) {
        unsafe {
            ffi::gtk_check_menu_item_set_inconsistent(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }
    ...
    fn connect_toggled<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn toggled_trampoline<P: IsA<CheckMenuItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCheckMenuItem, f: glib::ffi::gpointer) {
    ...
    fn connect_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_active_trampoline<P: IsA<CheckMenuItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCheckMenuItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CheckMenuItem::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_draw_as_radio_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_draw_as_radio_trampoline<P: IsA<CheckMenuItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCheckMenuItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CheckMenuItem::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::draw-as-radio\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_draw_as_radio_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "inconsistent")]
    fn connect_inconsistent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_inconsistent_trampoline<P: IsA<CheckMenuItem>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCheckMenuItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CheckMenuItem::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
