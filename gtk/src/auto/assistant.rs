...
use crate::{Align,Application,AssistantPageType,Bin,Buildable,Container,ResizeMode,Widget,Window,WindowPosition,WindowType};
...
pub trait AssistantExt: IsA<Assistant> + sealed::Sealed + 'static {
    ...
    fn set_forward_page_func(&self, page_func: Option<Box_<dyn Fn(i32) -> i32 + 'static>>) {
        ...
        unsafe extern "C" fn page_func_func(current_page: libc::c_int, data: glib::ffi::gpointer) -> libc::c_int {
        ...
        unsafe extern "C" fn destroy_func(data: glib::ffi::gpointer) {
            let _callback: Box_<Option<Box_<dyn Fn(i32) -> i32 + 'static>>> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(destroy_func as _);
        let super_callback0: Box_<Option<Box_<dyn Fn(i32) -> i32 + 'static>>> = page_func_data;
        unsafe {
            ffi::gtk_assistant_set_forward_page_func(self.as_ref().to_glib_none().0, page_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_page_complete(&self, page: &impl IsA<Widget>, complete: bool) {
        unsafe {
            ffi::gtk_assistant_set_page_complete(self.as_ref().to_glib_none().0, page.as_ref().to_glib_none().0, complete.into_glib());
        }
    }
    ...
    fn set_page_has_padding(&self, page: &impl IsA<Widget>, has_padding: bool) {
        unsafe {
            ffi::gtk_assistant_set_page_has_padding(self.as_ref().to_glib_none().0, page.as_ref().to_glib_none().0, has_padding.into_glib());
        }
    }
    ...
    fn set_page_type(&self, page: &impl IsA<Widget>, type_: AssistantPageType) {
        unsafe {
            ffi::gtk_assistant_set_page_type(self.as_ref().to_glib_none().0, page.as_ref().to_glib_none().0, type_.into_glib());
        }
    }
    ...
    fn child_is_complete<T: IsA<crate::Widget>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"complete")
    }

    fn set_child_complete<T: IsA<crate::Widget>>(&self, item: &T, complete: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"complete", &complete)
    }

    #[doc(alias = "child.has-padding")]
    fn child_has_padding<T: IsA<crate::Widget>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"has-padding")
    }

    #[doc(alias = "child.has-padding")]
    fn set_child_has_padding<T: IsA<crate::Widget>>(&self, item: &T, has_padding: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"has-padding", &has_padding)
    }

    #[doc(alias = "child.page-type")]
    fn child_page_type<T: IsA<crate::Widget>>(&self, item: &T) -> AssistantPageType {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"page-type")
    }

    #[doc(alias = "child.page-type")]
    fn set_child_page_type<T: IsA<crate::Widget>>(&self, item: &T, page_type: AssistantPageType) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"page-type", &page_type)
    }
    ...
    fn connect_apply<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn apply_trampoline<P: IsA<Assistant>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAssistant, f: glib::ffi::gpointer) {
    ...
    fn connect_cancel<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn cancel_trampoline<P: IsA<Assistant>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAssistant, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Assistant::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_close<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn close_trampoline<P: IsA<Assistant>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAssistant, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Assistant::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_escape<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn escape_trampoline<P: IsA<Assistant>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAssistant, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Assistant::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"escape\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(escape_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_prepare<F: Fn(&Self, &Widget) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn prepare_trampoline<P: IsA<Assistant>, F: Fn(&P, &Widget) + 'static>(this: *mut ffi::GtkAssistant, page: *mut ffi::GtkWidget, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Assistant::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(page))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"prepare\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(prepare_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
