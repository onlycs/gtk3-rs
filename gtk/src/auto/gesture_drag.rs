...
pub trait GestureDragExt: IsA<GestureDrag> + sealed::Sealed + 'static {
    ...
    fn offset(&self) -> Option<(f64, f64)> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_gesture_drag_get_offset(self.as_ref().to_glib_none().0, x.as_mut_ptr(), y.as_mut_ptr()));
    ...
    fn start_point(&self) -> Option<(f64, f64)> {
        unsafe {
            let mut x = std::mem::MaybeUninit::uninit();
            let mut y = std::mem::MaybeUninit::uninit();
            let ret = from_glib(ffi::gtk_gesture_drag_get_start_point(self.as_ref().to_glib_none().0, x.as_mut_ptr(), y.as_mut_ptr()));
            if ret { Some((x.assume_init(), y.assume_init())) } else { None }
        }
    }
    ...
    fn connect_drag_begin<F: Fn(&Self, f64, f64) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn drag_begin_trampoline<P: IsA<GestureDrag>, F: Fn(&P, f64, f64) + 'static>(this: *mut ffi::GtkGestureDrag, start_x: libc::c_double, start_y: libc::c_double, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(GestureDrag::from_glib_borrow(this).unsafe_cast_ref(), start_x, start_y)
        }
        unsafe {
    ...
    fn connect_drag_end<F: Fn(&Self, f64, f64) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn drag_end_trampoline<P: IsA<GestureDrag>, F: Fn(&P, f64, f64) + 'static>(this: *mut ffi::GtkGestureDrag, offset_x: libc::c_double, offset_y: libc::c_double, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(GestureDrag::from_glib_borrow(this).unsafe_cast_ref(), offset_x, offset_y)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_drag_update<F: Fn(&Self, f64, f64) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn drag_update_trampoline<P: IsA<GestureDrag>, F: Fn(&P, f64, f64) + 'static>(this: *mut ffi::GtkGestureDrag, offset_x: libc::c_double, offset_y: libc::c_double, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(GestureDrag::from_glib_borrow(this).unsafe_cast_ref(), offset_x, offset_y)
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"drag-update\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(drag_update_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
