...
use crate::{Adjustment,Align,Buildable,Container,ListBoxRow,MovementStep,ResizeMode,SelectionMode,Widget};
...
pub trait ListBoxExt: IsA<ListBox> + sealed::Sealed + 'static {
    ...
    fn bind_model<P: Fn(&glib::Object) -> Widget + 'static>(&self, model: Option<&impl IsA<gio::ListModel>>, create_widget_func: P) {
        ...
        unsafe {
            ffi::gtk_list_box_bind_model(self.as_ref().to_glib_none().0, model.map(|p| p.as_ref()).to_glib_none().0, create_widget_func, Box_::into_raw(super_callback0) as *mut _, destroy_call4);
        }
    }
    ...
    fn selected_foreach<P: FnMut(&ListBox, &ListBoxRow)>(&self, func: P) {
        ...
        unsafe extern "C" fn func_func<P: FnMut(&ListBox, &ListBoxRow)>(box_: *mut ffi::GtkListBox, row: *mut ffi::GtkListBoxRow, user_data: glib::ffi::gpointer) {
    ...
    fn set_activate_on_single_click(&self, single: bool) {
        unsafe {
            ffi::gtk_list_box_set_activate_on_single_click(self.as_ref().to_glib_none().0, single.into_glib());
        }
    }
    ...
    fn set_filter_func(&self, filter_func: Option<Box_<dyn Fn(&ListBoxRow) -> bool + 'static>>) {
        let filter_func_data: Box_<Option<Box_<dyn Fn(&ListBoxRow) -> bool + 'static>>> = Box_::new(filter_func);
        unsafe extern "C" fn filter_func_func(row: *mut ffi::GtkListBoxRow, user_data: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let row = from_glib_borrow(row);
            let callback: &Option<Box_<dyn Fn(&ListBoxRow) -> bool + 'static>> = &*(user_data as *mut _);
        ...
        unsafe extern "C" fn destroy_func(data: glib::ffi::gpointer) {
            let _callback: Box_<Option<Box_<dyn Fn(&ListBoxRow) -> bool + 'static>>> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(destroy_func as _);
        let super_callback0: Box_<Option<Box_<dyn Fn(&ListBoxRow) -> bool + 'static>>> = filter_func_data;
        unsafe {
            ffi::gtk_list_box_set_filter_func(self.as_ref().to_glib_none().0, filter_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_header_func(&self, update_header: Option<Box_<dyn Fn(&ListBoxRow, Option<&ListBoxRow>) + 'static>>) {
        let update_header_data: Box_<Option<Box_<dyn Fn(&ListBoxRow, Option<&ListBoxRow>) + 'static>>> = Box_::new(update_header);
        unsafe extern "C" fn update_header_func(row: *mut ffi::GtkListBoxRow, before: *mut ffi::GtkListBoxRow, user_data: glib::ffi::gpointer) {
            let row = from_glib_borrow(row);
            let before: Borrowed<Option<ListBoxRow>> = from_glib_borrow(before);
            let callback: &Option<Box_<dyn Fn(&ListBoxRow, Option<&ListBoxRow>) + 'static>> = &*(user_data as *mut _);
            if let Some(ref callback) = *callback {
        ...
        unsafe extern "C" fn destroy_func(data: glib::ffi::gpointer) {
            let _callback: Box_<Option<Box_<dyn Fn(&ListBoxRow, Option<&ListBoxRow>) + 'static>>> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(destroy_func as _);
        let super_callback0: Box_<Option<Box_<dyn Fn(&ListBoxRow, Option<&ListBoxRow>) + 'static>>> = update_header_data;
        unsafe {
            ffi::gtk_list_box_set_header_func(self.as_ref().to_glib_none().0, update_header, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_sort_func(&self, sort_func: Option<Box_<dyn Fn(&ListBoxRow, &ListBoxRow) -> i32 + 'static>>) {
        let sort_func_data: Box_<Option<Box_<dyn Fn(&ListBoxRow, &ListBoxRow) -> i32 + 'static>>> = Box_::new(sort_func);
        unsafe extern "C" fn sort_func_func(row1: *mut ffi::GtkListBoxRow, row2: *mut ffi::GtkListBoxRow, user_data: glib::ffi::gpointer) -> libc::c_int {
            let row1 = from_glib_borrow(row1);
            let row2 = from_glib_borrow(row2);
            let callback: &Option<Box_<dyn Fn(&ListBoxRow, &ListBoxRow) -> i32 + 'static>> = &*(user_data as *mut _);
            if let Some(ref callback) = *callback {
                callback(&row1, &row2)
            } else {
                panic!("cannot get closure...")
        ...
        unsafe extern "C" fn destroy_func(data: glib::ffi::gpointer) {
            let _callback: Box_<Option<Box_<dyn Fn(&ListBoxRow, &ListBoxRow) -> i32 + 'static>>> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(destroy_func as _);
        let super_callback0: Box_<Option<Box_<dyn Fn(&ListBoxRow, &ListBoxRow) -> i32 + 'static>>> = sort_func_data;
        unsafe {
            ffi::gtk_list_box_set_sort_func(self.as_ref().to_glib_none().0, sort_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn connect_activate_cursor_row<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activate_cursor_row_trampoline<P: IsA<ListBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBox, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"activate-cursor-row\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(activate_cursor_row_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_move_cursor<F: Fn(&Self, MovementStep, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn move_cursor_trampoline<P: IsA<ListBox>, F: Fn(&P, MovementStep, i32) + 'static>(this: *mut ffi::GtkListBox, object: ffi::GtkMovementStep, p0: libc::c_int, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref(), from_glib(object), p0)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_row_activated<F: Fn(&Self, &ListBoxRow) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn row_activated_trampoline<P: IsA<ListBox>, F: Fn(&P, &ListBoxRow) + 'static>(this: *mut ffi::GtkListBox, row: *mut ffi::GtkListBoxRow, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(row))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    fn connect_row_selected<F: Fn(&Self, Option<&ListBoxRow>) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn row_selected_trampoline<P: IsA<ListBox>, F: Fn(&P, Option<&ListBoxRow>) + 'static>(this: *mut ffi::GtkListBox, row: *mut ffi::GtkListBoxRow, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref(), Option::<ListBoxRow>::from_glib_borrow(row).as_ref().as_ref())
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"row-selected\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(row_selected_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "select-all")]
    fn connect_select_all<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn select_all_trampoline<P: IsA<ListBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_selected_rows_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn selected_rows_changed_trampoline<P: IsA<ListBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"selected-rows-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(selected_rows_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "toggle-cursor-row")]
    fn connect_toggle_cursor_row<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn toggle_cursor_row_trampoline<P: IsA<ListBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_unselect_all<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn unselect_all_trampoline<P: IsA<ListBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBox, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_activate_on_single_click_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_activate_on_single_click_trampoline<P: IsA<ListBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_selection_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selection_mode_trampoline<P: IsA<ListBox>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBox::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
