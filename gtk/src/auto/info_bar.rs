...
use crate::{Align,BaselinePosition,Box,Buildable,Button,Container,MessageType,Orientable,Orientation,ResizeMode,ResponseType,Widget};
...
pub struct InfoBarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("revealed", revealed), }
                        }
...
pub trait InfoBarExt: IsA<InfoBar> + sealed::Sealed + 'static {
    ...
    fn add_action_widget(&self, child: &impl IsA<Widget>, response_id: ResponseType) {
        unsafe {
            ffi::gtk_info_bar_add_action_widget(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, response_id.into_glib());
        }
    }
    ...
    fn add_button(&self, button_text: &str, response_id: ResponseType) -> Option<Button> {
        unsafe {
            from_glib_none(ffi::gtk_info_bar_add_button(self.as_ref().to_glib_none().0, button_text.to_glib_none().0, response_id.into_glib()))
        }
    }
    ...
    fn set_default_response(&self, response_id: ResponseType) {
        unsafe {
            ffi::gtk_info_bar_set_default_response(self.as_ref().to_glib_none().0, response_id.into_glib());
        }
    }
    ...
    fn set_message_type(&self, message_type: MessageType) {
        unsafe {
            ffi::gtk_info_bar_set_message_type(self.as_ref().to_glib_none().0, message_type.into_glib());
        }
    }
    ...
    fn set_response_sensitive(&self, response_id: ResponseType, setting: bool) {
        unsafe {
            ffi::gtk_info_bar_set_response_sensitive(self.as_ref().to_glib_none().0, response_id.into_glib(), setting.into_glib());
        }
    }
    ...
    fn set_show_close_button(&self, setting: bool) {
        unsafe {
            ffi::gtk_info_bar_set_show_close_button(self.as_ref().to_glib_none().0, setting.into_glib());
        }
    }

    #[doc(alias = "close")]
    fn connect_close<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn close_trampoline<P: IsA<InfoBar>, F: Fn(&P) + 'static>(this: *mut ffi::GtkInfoBar, f: glib::ffi::gpointer) {
    ...
    fn connect_response<F: Fn(&Self, ResponseType) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn response_trampoline<P: IsA<InfoBar>, F: Fn(&P, ResponseType) + 'static>(this: *mut ffi::GtkInfoBar, response_id: ffi::GtkResponseType, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(InfoBar::from_glib_borrow(this).unsafe_cast_ref(), from_glib(response_id))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"response\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(response_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "message-type")]
    fn connect_message_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_message_type_trampoline<P: IsA<InfoBar>, F: Fn(&P) + 'static>(this: *mut ffi::GtkInfoBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(InfoBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::message-type\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_message_type_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "revealed")]
    fn connect_revealed_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_revealed_trampoline<P: IsA<InfoBar>, F: Fn(&P) + 'static>(this: *mut ffi::GtkInfoBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(InfoBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::revealed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_revealed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-close-button")]
    fn connect_show_close_button_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_close_button_trampoline<P: IsA<InfoBar>, F: Fn(&P) + 'static>(this: *mut ffi::GtkInfoBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(InfoBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
