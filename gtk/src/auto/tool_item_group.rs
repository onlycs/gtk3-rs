...
pub struct ToolItemGroupBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("collapsed", collapsed), }
                        }
                            ...
                            Self { builder: self.builder.property("header-relief", header_relief), }
                        }
...
pub trait ToolItemGroupExt: IsA<ToolItemGroup> + sealed::Sealed + 'static {
    ...
    fn set_collapsed(&self, collapsed: bool) {
        unsafe {
            ffi::gtk_tool_item_group_set_collapsed(self.as_ref().to_glib_none().0, collapsed.into_glib());
        }
    }
    ...
    fn set_ellipsize(&self, ellipsize: pango::EllipsizeMode) {
        unsafe {
            ffi::gtk_tool_item_group_set_ellipsize(self.as_ref().to_glib_none().0, ellipsize.into_glib());
        }
    }
    ...
    fn set_header_relief(&self, style: ReliefStyle) {
        unsafe {
            ffi::gtk_tool_item_group_set_header_relief(self.as_ref().to_glib_none().0, style.into_glib());
        }
    }
    ...
    fn item_is_new_row<T: IsA<ToolItem>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"new-row")
    }

    #[doc(alias = "item.new-row")]
    fn set_item_new_row<T: IsA<ToolItem>>(&self, item: &T, new_row: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"new-row", &new_row)
    }

    #[doc(alias = "collapsed")]
    fn connect_collapsed_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_collapsed_trampoline<P: IsA<ToolItemGroup>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItemGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::collapsed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_collapsed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "ellipsize")]
    fn connect_ellipsize_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_ellipsize_trampoline<P: IsA<ToolItemGroup>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItemGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolItemGroup::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_header_relief_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_header_relief_trampoline<P: IsA<ToolItemGroup>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItemGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolItemGroup::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::header-relief\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_header_relief_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "label")]
    fn connect_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_trampoline<P: IsA<ToolItemGroup>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItemGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolItemGroup::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_label_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_widget_trampoline<P: IsA<ToolItemGroup>, F: Fn(&P) + 'static>(this: *mut ffi::GtkToolItemGroup, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ToolItemGroup::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
