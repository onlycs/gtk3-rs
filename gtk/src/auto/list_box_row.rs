...
pub trait ListBoxRowExt: IsA<ListBoxRow> + sealed::Sealed + 'static {
    ...
    fn set_activatable(&self, activatable: bool) {
        unsafe {
            ffi::gtk_list_box_row_set_activatable(self.as_ref().to_glib_none().0, activatable.into_glib());
        }
    }
    ...
    fn set_selectable(&self, selectable: bool) {
        unsafe {
            ffi::gtk_list_box_row_set_selectable(self.as_ref().to_glib_none().0, selectable.into_glib());
        }
    }

    #[doc(alias = "activate")]
    fn connect_activate<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activate_trampoline<P: IsA<ListBoxRow>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBoxRow, f: glib::ffi::gpointer) {
    ...
    fn connect_activatable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_activatable_trampoline<P: IsA<ListBoxRow>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBoxRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBoxRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_selectable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_selectable_trampoline<P: IsA<ListBoxRow>, F: Fn(&P) + 'static>(this: *mut ffi::GtkListBoxRow, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(ListBoxRow::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
