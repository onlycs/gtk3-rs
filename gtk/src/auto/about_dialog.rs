...
use crate::{Align,Application,Bin,Buildable,Container,Dialog,License,ResizeMode,Widget,Window,WindowPosition,WindowType};
...
pub struct AboutDialogBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("artists", artists.into()), }
                        }

                            pub fn authors(self, authors: impl Into<glib::StrV>) -> Self {
                            Self { builder: self.builder.property("authors", authors.into()), }
                        }
                            ...
                            Self { builder: self.builder.property("copyright", copyright.into()), }
                        }

                            pub fn documenters(self, documenters: impl Into<glib::StrV>) -> Self {
                            Self { builder: self.builder.property("documenters", documenters.into()), }
                        }
                            ...
                            Self { builder: self.builder.property("license-type", license_type), }
                        }

                            pub fn logo(self, logo: &gdk_pixbuf::Pixbuf) -> Self {
                            Self { builder: self.builder.property("logo", logo.clone()), }
                        }

                            pub fn logo_icon_name(self, logo_icon_name: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("logo-icon-name", logo_icon_name.into()), }
                        }

                            pub fn program_name(self, program_name: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("program-name", program_name.into()), }
                        }

                            pub fn translator_credits(self, translator_credits: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("translator-credits", translator_credits.into()), }
                        }
                            ...
                            Self { builder: self.builder.property("website", website.into()), }
                        }

                            pub fn website_label(self, website_label: impl Into<glib::GString>) -> Self {
                            Self { builder: self.builder.property("website-label", website_label.into()), }
                        }

                            pub fn wrap_license(self, wrap_license: bool) -> Self {
                            Self { builder: self.builder.property("wrap-license", wrap_license), }
                        }

                            pub fn use_header_bar(self, use_header_bar: i32) -> Self {
                            Self { builder: self.builder.property("use-header-bar", use_header_bar), }
                        }
...
pub trait AboutDialogExt: IsA<AboutDialog> + sealed::Sealed + 'static {
    ...
    fn set_license_type(&self, license_type: License) {
        unsafe {
            ffi::gtk_about_dialog_set_license_type(self.as_ref().to_glib_none().0, license_type.into_glib());
        }
    }
    ...
    fn set_wrap_license(&self, wrap_license: bool) {
        unsafe {
            ffi::gtk_about_dialog_set_wrap_license(self.as_ref().to_glib_none().0, wrap_license.into_glib());
        }
    }

    #[doc(alias = "activate-link")]
    fn connect_activate_link<F: Fn(&Self, &str) -> glib::Propagation + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn activate_link_trampoline<P: IsA<AboutDialog>, F: Fn(&P, &str) -> glib::Propagation + 'static>(this: *mut ffi::GtkAboutDialog, uri: *mut libc::c_char, f: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref(), &glib::GString::from_glib_borrow(uri)).into_glib()
        }
        unsafe {
    ...
    fn connect_artists_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_artists_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::artists\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_artists_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "authors")]
    fn connect_authors_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_authors_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::authors\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_authors_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "comments")]
    fn connect_comments_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_comments_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::comments\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_comments_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "copyright")]
    fn connect_copyright_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_copyright_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::copyright\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_copyright_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "documenters")]
    fn connect_documenters_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_documenters_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::documenters\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_documenters_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "license")]
    fn connect_license_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_license_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_license_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_license_type_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::license-type\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_license_type_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "logo")]
    fn connect_logo_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_logo_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::logo\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_logo_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "logo-icon-name")]
    fn connect_logo_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_logo_icon_name_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::logo-icon-name\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_logo_icon_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "program-name")]
    fn connect_program_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_program_name_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::program-name\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_program_name_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "translator-credits")]
    fn connect_translator_credits_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_translator_credits_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::translator-credits\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_translator_credits_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "version")]
    fn connect_version_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_version_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_website_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_website_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::website\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_website_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "website-label")]
    fn connect_website_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_website_label_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::website-label\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_website_label_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "wrap-license")]
    fn connect_wrap_license_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_wrap_license_trampoline<P: IsA<AboutDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAboutDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AboutDialog::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::wrap-license\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_wrap_license_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
