...
use crate::{Actionable,Activatable,Align,Bin,Buildable,Button,CheckButton,Container,PositionType,ReliefStyle,ResizeMode,ToggleButton,Widget};
use glib::{prelude::*,signal::{connect_raw, SignalHandlerId},translate::*};
use std::{boxed::Box as Box_};

glib::wrapper! {
    #[doc(alias = "GtkRadioButton")]
    pub struct RadioButton(Object<ffi::GtkRadioButton, ffi::GtkRadioButtonClass>) @extends CheckButton, ToggleButton, Button, Bin, Container, Widget, @implements Buildable, Actionable, Activatable;
...
impl RadioButton {
    ...
    pub fn with_label_from_widget(radio_group_member: &impl IsA<RadioButton>, label: &str) -> RadioButton {
        skip_assert_initialized!();
        unsafe {
    ...
    pub fn with_mnemonic_from_widget(radio_group_member: &impl IsA<RadioButton>, label: &str) -> RadioButton {
        skip_assert_initialized!();
        unsafe {
...
pub trait RadioButtonExt: IsA<RadioButton> + sealed::Sealed + 'static {
    ...
    fn connect_group_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn group_changed_trampoline<P: IsA<RadioButton>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRadioButton, f: glib::ffi::gpointer) {
