...
pub trait RecentChooserExt: IsA<RecentChooser> + sealed::Sealed + 'static {
    ...
    fn uris(&self) -> Vec<glib::GString> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_full_num(ffi::gtk_recent_chooser_get_uris(self.as_ref().to_glib_none().0, length.as_mut_ptr()), length.assume_init() as _);
            ret
        }
    }
    ...
    fn select_uri(&self, uri: &str) -> Result<(), glib::Error> {
        unsafe {
            ...
            let is_ok = ffi::gtk_recent_chooser_select_uri(self.as_ref().to_glib_none().0, uri.to_glib_none().0, &mut error);
    ...
    fn set_current_uri(&self, uri: &str) -> Result<(), glib::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
            let is_ok = ffi::gtk_recent_chooser_set_current_uri(self.as_ref().to_glib_none().0, uri.to_glib_none().0, &mut error);
            debug_assert_eq!(is_ok == glib::ffi::GFALSE, !error.is_null());
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn set_local_only(&self, local_only: bool) {
        unsafe {
            ffi::gtk_recent_chooser_set_local_only(self.as_ref().to_glib_none().0, local_only.into_glib());
        }
    }
    ...
    fn set_select_multiple(&self, select_multiple: bool) {
        unsafe {
            ffi::gtk_recent_chooser_set_select_multiple(self.as_ref().to_glib_none().0, select_multiple.into_glib());
        }
    }
    ...
    fn set_show_icons(&self, show_icons: bool) {
        unsafe {
            ffi::gtk_recent_chooser_set_show_icons(self.as_ref().to_glib_none().0, show_icons.into_glib());
        }
    }
    ...
    fn set_show_not_found(&self, show_not_found: bool) {
        unsafe {
            ffi::gtk_recent_chooser_set_show_not_found(self.as_ref().to_glib_none().0, show_not_found.into_glib());
        }
    }
    ...
    fn set_show_private(&self, show_private: bool) {
        unsafe {
            ffi::gtk_recent_chooser_set_show_private(self.as_ref().to_glib_none().0, show_private.into_glib());
        }
    }
    ...
    fn set_show_tips(&self, show_tips: bool) {
        unsafe {
            ffi::gtk_recent_chooser_set_show_tips(self.as_ref().to_glib_none().0, show_tips.into_glib());
        }
    }
    ...
    fn set_sort_func<P: Fn(&RecentInfo, &RecentInfo) -> i32 + 'static>(&self, sort_func: P) {
        ...
        unsafe extern "C" fn sort_func_func<P: Fn(&RecentInfo, &RecentInfo) -> i32 + 'static>(a: *mut ffi::GtkRecentInfo, b: *mut ffi::GtkRecentInfo, user_data: glib::ffi::gpointer) -> libc::c_int {
        ...
        unsafe extern "C" fn data_destroy_func<P: Fn(&RecentInfo, &RecentInfo) -> i32 + 'static>(data: glib::ffi::gpointer) {
            let _callback: Box_<P> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(data_destroy_func::<P> as _);
        let super_callback0: Box_<P> = sort_func_data;
        unsafe {
            ffi::gtk_recent_chooser_set_sort_func(self.as_ref().to_glib_none().0, sort_func, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }
    ...
    fn set_sort_type(&self, sort_type: RecentSortType) {
        unsafe {
            ffi::gtk_recent_chooser_set_sort_type(self.as_ref().to_glib_none().0, sort_type.into_glib());
        }
    }
    ...
    fn connect_item_activated<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn item_activated_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, f: glib::ffi::gpointer) {
    ...
    fn connect_selection_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn selection_changed_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_filter_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_filter_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_limit_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_limit_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::limit\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_limit_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "local-only")]
    fn connect_local_only_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_local_only_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_select_multiple_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_select_multiple_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_show_icons_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_icons_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-icons\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_icons_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-not-found")]
    fn connect_show_not_found_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_not_found_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-not-found\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_not_found_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-private")]
    fn connect_show_private_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_private_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-private\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_private_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "show-tips")]
    fn connect_show_tips_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_tips_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::show-tips\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_show_tips_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "sort-type")]
    fn connect_sort_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_sort_type_trampoline<P: IsA<RecentChooser>, F: Fn(&P) + 'static>(this: *mut ffi::GtkRecentChooser, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(RecentChooser::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::sort-type\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_sort_type_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
