...
use crate::{Align,Application,Bin,Buildable,ColorChooser,Container,Dialog,ResizeMode,Widget,Window,WindowPosition,WindowType};
...
pub trait ColorChooserDialogExt: IsA<ColorChooserDialog> + sealed::Sealed + 'static {
    ...
    fn connect_show_editor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_editor_trampoline<P: IsA<ColorChooserDialog>, F: Fn(&P) + 'static>(this: *mut ffi::GtkColorChooserDialog, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
