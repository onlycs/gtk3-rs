...
use crate::{AccelGroup,Orientation,PageSetup,PositionType,PrintSettings,SelectionData,StyleContext,TextBuffer,TextDirection,TreeModel,TreePath,Widget,Window};
use glib::{prelude::*,translate::*};
use std::{boxed::Box as Box_};


#[doc(alias = "gtk_accel_groups_activate")]
pub fn accel_groups_activate(object: &impl IsA<glib::Object>, accel_key: u32, accel_mods: gdk::ModifierType) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(ffi::gtk_accel_groups_activate(object.as_ref().to_glib_none().0, accel_key, accel_mods.into_glib()))
    }
}
...
pub fn accelerator_get_label(accelerator_key: u32, accelerator_mods: gdk::ModifierType) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::gtk_accelerator_get_label(accelerator_key, accelerator_mods.into_glib()))
    }
}

#[doc(alias = "gtk_accelerator_get_label_with_keycode")]
pub fn accelerator_get_label_with_keycode(display: Option<&gdk::Display>, accelerator_key: u32, keycode: u32, accelerator_mods: gdk::ModifierType) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::gtk_accelerator_get_label_with_keycode(display.to_glib_none().0, accelerator_key, keycode, accelerator_mods.into_glib()))
    }
}

#[doc(alias = "gtk_accelerator_name")]
pub fn accelerator_name(accelerator_key: u32, accelerator_mods: gdk::ModifierType) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::gtk_accelerator_name(accelerator_key, accelerator_mods.into_glib()))
    }
}

#[doc(alias = "gtk_accelerator_name_with_keycode")]
pub fn accelerator_name_with_keycode(display: Option<&gdk::Display>, accelerator_key: u32, keycode: u32, accelerator_mods: gdk::ModifierType) -> Option<glib::GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(ffi::gtk_accelerator_name_with_keycode(display.to_glib_none().0, accelerator_key, keycode, accelerator_mods.into_glib()))
    }
}
...
pub fn accelerator_parse(accelerator: &str) -> (u32, gdk::ModifierType) {
    ...
    unsafe {
        ...
        ffi::gtk_accelerator_parse(accelerator.to_glib_none().0, accelerator_key.as_mut_ptr(), accelerator_mods.as_mut_ptr());
...
pub fn accelerator_valid(keyval: u32, modifiers: gdk::ModifierType) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(ffi::gtk_accelerator_valid(keyval, modifiers.into_glib()))
    }
}

#[doc(alias = "gtk_bindings_activate")]
pub fn bindings_activate(object: &impl IsA<glib::Object>, keyval: u32, modifiers: gdk::ModifierType) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(ffi::gtk_bindings_activate(object.as_ref().to_glib_none().0, keyval, modifiers.into_glib()))
    }
}
...
pub fn cairo_transform_to_window(cr: &cairo::Context, widget: &impl IsA<Widget>, window: &gdk::Window) {
    skip_assert_initialized!();
    unsafe {
        ffi::gtk_cairo_transform_to_window(mut_override(cr.to_glib_none().0), widget.as_ref().to_glib_none().0, window.to_glib_none().0);
    }
}

#[doc(alias = "gtk_check_version")]
pub fn check_version(required_major: u32, required_minor: u32, required_micro: u32) -> Option<glib::GString> {
    skip_assert_initialized!();
    unsafe {
...
pub fn device_grab_add(widget: &impl IsA<Widget>, device: &gdk::Device, block_others: bool) {
    skip_assert_initialized!();
    unsafe {
        ffi::gtk_device_grab_add(widget.as_ref().to_glib_none().0, device.to_glib_none().0, block_others.into_glib());
    }
}
...
pub fn current_event_state() -> Option<gdk::ModifierType> {
    ...
    unsafe {
        ...
        if ret { Some(from_glib(state.assume_init())) } else { None }
    }
}
...
pub fn main_iteration_do(blocking: bool) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(ffi::gtk_main_iteration_do(blocking.into_glib()))
    }
}
...
pub fn print_run_page_setup_dialog(parent: Option<&impl IsA<Window>>, page_setup: Option<&PageSetup>, settings: &PrintSettings) -> Option<PageSetup> {
    skip_assert_initialized!();
    unsafe {
...
pub fn print_run_page_setup_dialog_async<P: FnOnce(&PageSetup) + Send + Sync + 'static>(parent: Option<&impl IsA<Window>>, page_setup: Option<&PageSetup>, settings: &PrintSettings, done_cb: P) {
    skip_assert_initialized!();
    let done_cb_data: Box_<P> = Box_::new(done_cb);
    unsafe extern "C" fn done_cb_func<P: FnOnce(&PageSetup) + Send + Sync + 'static>(page_setup: *mut ffi::GtkPageSetup, data: glib::ffi::gpointer) {
    ...
    unsafe {
        ffi::gtk_print_run_page_setup_dialog_async(parent.map(|p| p.as_ref()).to_glib_none().0, page_setup.to_glib_none().0, settings.to_glib_none().0, done_cb, Box_::into_raw(super_callback0) as *mut _);
    }
}
...
pub fn render_activity(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_arrow(context: &impl IsA<StyleContext>, cr: &cairo::Context, angle: f64, x: f64, y: f64, size: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_background(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_background_get_clip(context: &impl IsA<StyleContext>, x: f64, y: f64, width: f64, height: f64) -> gdk::Rectangle {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_check(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_expander(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_extension(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64, gap_side: PositionType) {
    skip_assert_initialized!();
    unsafe {
        ffi::gtk_render_extension(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), x, y, width, height, gap_side.into_glib());
    }
}

#[doc(alias = "gtk_render_focus")]
pub fn render_focus(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_frame(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_frame_gap(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64, gap_side: PositionType, xy0_gap: f64, xy1_gap: f64) {
    skip_assert_initialized!();
    unsafe {
        ffi::gtk_render_frame_gap(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), x, y, width, height, gap_side.into_glib(), xy0_gap, xy1_gap);
    }
}

#[doc(alias = "gtk_render_handle")]
pub fn render_handle(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_icon(context: &impl IsA<StyleContext>, cr: &cairo::Context, pixbuf: &gdk_pixbuf::Pixbuf, x: f64, y: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_icon_surface(context: &impl IsA<StyleContext>, cr: &cairo::Context, surface: &cairo::Surface, x: f64, y: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_insertion_cursor(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, layout: &pango::Layout, index: i32, direction: pango::Direction) {
    skip_assert_initialized!();
    unsafe {
        ffi::gtk_render_insertion_cursor(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), x, y, layout.to_glib_none().0, index, direction.into_glib());
    }
}

#[doc(alias = "gtk_render_layout")]
pub fn render_layout(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, layout: &pango::Layout) {
    skip_assert_initialized!();
    unsafe {
        ffi::gtk_render_layout(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), x, y, layout.to_glib_none().0);
    }
}

#[doc(alias = "gtk_render_line")]
pub fn render_line(context: &impl IsA<StyleContext>, cr: &cairo::Context, x0: f64, y0: f64, x1: f64, y1: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_option(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64) {
    skip_assert_initialized!();
    unsafe {
...
pub fn render_slider(context: &impl IsA<StyleContext>, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64, orientation: Orientation) {
    skip_assert_initialized!();
    unsafe {
        ffi::gtk_render_slider(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), x, y, width, height, orientation.into_glib());
    }
}
...
pub fn selection_add_target(widget: &impl IsA<Widget>, selection: &gdk::Atom, target: &gdk::Atom, info: u32) {
    skip_assert_initialized!();
    unsafe {
...
pub fn selection_convert(widget: &impl IsA<Widget>, selection: &gdk::Atom, target: &gdk::Atom, time_: u32) -> bool {
    skip_assert_initialized!();
    unsafe {
...
pub fn selection_owner_set(widget: Option<&impl IsA<Widget>>, selection: &gdk::Atom, time_: u32) -> bool {
    assert_initialized_main_thread!();
    unsafe {
...
pub fn selection_owner_set_for_display(display: &gdk::Display, widget: Option<&impl IsA<Widget>>, selection: &gdk::Atom, time_: u32) -> bool {
    assert_initialized_main_thread!();
    unsafe {
...
pub fn show_uri_on_window(parent: Option<&impl IsA<Window>>, uri: &str, timestamp: u32) -> Result<(), glib::Error> {
    assert_initialized_main_thread!();
    unsafe {
        let mut error = std::ptr::null_mut();
        let is_ok = ffi::gtk_show_uri_on_window(parent.map(|p| p.as_ref()).to_glib_none().0, uri.to_glib_none().0, timestamp, &mut error);
...
pub fn targets_include_image(targets: &[gdk::Atom], writable: bool) -> bool {
    ...
    unsafe {
        from_glib(ffi::gtk_targets_include_image(targets.to_glib_none().0, n_targets, writable.into_glib()))
    }
}
...
pub fn test_find_sibling(base_widget: &impl IsA<Widget>, widget_type: glib::types::Type) -> Option<Widget> {
    skip_assert_initialized!();
    unsafe {
        from_glib_none(ffi::gtk_test_find_sibling(base_widget.as_ref().to_glib_none().0, widget_type.into_glib()))
    }
}

#[doc(alias = "gtk_test_find_widget")]
pub fn test_find_widget(widget: &impl IsA<Widget>, label_pattern: &str, widget_type: glib::types::Type) -> Option<Widget> {
    skip_assert_initialized!();
    unsafe {
        from_glib_none(ffi::gtk_test_find_widget(widget.as_ref().to_glib_none().0, label_pattern.to_glib_none().0, widget_type.into_glib()))
    }
}
...
pub fn test_widget_send_key(widget: &impl IsA<Widget>, keyval: u32, modifiers: gdk::ModifierType) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(ffi::gtk_test_widget_send_key(widget.as_ref().to_glib_none().0, keyval, modifiers.into_glib()))
    }
}
...
pub fn tree_set_row_drag_data(selection_data: &SelectionData, tree_model: &impl IsA<TreeModel>, path: &mut TreePath) -> bool {
    skip_assert_initialized!();
    unsafe {
