...
impl IconTheme {
    ...
    #[allow(clippy::should_implement_trait)]    pub fn default() -> Option<IconTheme> {
        assert_initialized_main_thread!();
        unsafe {
...
pub trait IconThemeExt: IsA<IconTheme> + sealed::Sealed + 'static {
    ...
    fn load_icon(&self, icon_name: &str, size: i32, flags: IconLookupFlags) -> Result<Option<gdk_pixbuf::Pixbuf>, glib::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
            let ret = ffi::gtk_icon_theme_load_icon(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0, size, flags.into_glib(), &mut error);
            if error.is_null() { Ok(from_glib_full(ret)) } else { Err(from_glib_full(error)) }
        }
    }

    #[doc(alias = "gtk_icon_theme_load_icon_for_scale")]
    fn load_icon_for_scale(&self, icon_name: &str, size: i32, scale: i32, flags: IconLookupFlags) -> Result<Option<gdk_pixbuf::Pixbuf>, glib::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
            let ret = ffi::gtk_icon_theme_load_icon_for_scale(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0, size, scale, flags.into_glib(), &mut error);
            if error.is_null() { Ok(from_glib_full(ret)) } else { Err(from_glib_full(error)) }
        }
    }

    #[doc(alias = "gtk_icon_theme_load_surface")]
    fn load_surface(&self, icon_name: &str, size: i32, scale: i32, for_window: Option<&gdk::Window>, flags: IconLookupFlags) -> Result<Option<cairo::Surface>, glib::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
            let ret = ffi::gtk_icon_theme_load_surface(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0, size, scale, for_window.to_glib_none().0, flags.into_glib(), &mut error);
            if error.is_null() { Ok(from_glib_full(ret)) } else { Err(from_glib_full(error)) }
        }
    }

    #[doc(alias = "gtk_icon_theme_lookup_by_gicon")]
    fn lookup_by_gicon(&self, icon: &impl IsA<gio::Icon>, size: i32, flags: IconLookupFlags) -> Option<IconInfo> {
        unsafe {
            from_glib_full(ffi::gtk_icon_theme_lookup_by_gicon(self.as_ref().to_glib_none().0, icon.as_ref().to_glib_none().0, size, flags.into_glib()))
        }
    }

    #[doc(alias = "gtk_icon_theme_lookup_by_gicon_for_scale")]
    fn lookup_by_gicon_for_scale(&self, icon: &impl IsA<gio::Icon>, size: i32, scale: i32, flags: IconLookupFlags) -> Option<IconInfo> {
        unsafe {
            from_glib_full(ffi::gtk_icon_theme_lookup_by_gicon_for_scale(self.as_ref().to_glib_none().0, icon.as_ref().to_glib_none().0, size, scale, flags.into_glib()))
        }
    }
    ...
    fn lookup_icon(&self, icon_name: &str, size: i32, flags: IconLookupFlags) -> Option<IconInfo> {
        unsafe {
            from_glib_full(ffi::gtk_icon_theme_lookup_icon(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0, size, flags.into_glib()))
        }
    }
    ...
    fn lookup_icon_for_scale(&self, icon_name: &str, size: i32, scale: i32, flags: IconLookupFlags) -> Option<IconInfo> {
        unsafe {
            from_glib_full(ffi::gtk_icon_theme_lookup_icon_for_scale(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0, size, scale, flags.into_glib()))
        }
    }
    ...
    fn connect_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn changed_trampoline<P: IsA<IconTheme>, F: Fn(&P) + 'static>(this: *mut ffi::GtkIconTheme, f: glib::ffi::gpointer) {
