...
impl PadController {
    ...
    pub fn new(window: &impl IsA<Window>, group: &impl IsA<gio::ActionGroup>, pad: Option<&gdk::Device>) -> PadController {
    ...
    pub fn set_action(&self, type_: PadActionType, index: i32, mode: i32, label: &str, action_name: &str) {
        unsafe {
            ffi::gtk_pad_controller_set_action(self.to_glib_none().0, type_.into_glib(), index, mode, label.to_glib_none().0, action_name.to_glib_none().0);
        }
    }
...
pub struct PadControllerBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("pad", pad.clone()), }
                        }
