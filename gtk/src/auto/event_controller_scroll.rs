...
impl EventControllerScroll {
    ...
    pub fn new(widget: &impl IsA<Widget>, flags: EventControllerScrollFlags) -> EventControllerScroll {
        skip_assert_initialized!();
        unsafe {
            EventController::from_glib_full(ffi::gtk_event_controller_scroll_new(widget.as_ref().to_glib_none().0, flags.into_glib())).unsafe_cast()
        }
    }
    ...
    pub fn flags(&self) -> EventControllerScrollFlags {
        unsafe {
            from_glib(ffi::gtk_event_controller_scroll_get_flags(self.to_glib_none().0))
        }
    }
    ...
    pub fn connect_decelerate<F: Fn(&Self, f64, f64) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn decelerate_trampoline<F: Fn(&EventControllerScroll, f64, f64) + 'static>(this: *mut ffi::GtkEventControllerScroll, vel_x: libc::c_double, vel_y: libc::c_double, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"decelerate\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(decelerate_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "scroll")]
    pub fn connect_scroll<F: Fn(&Self, f64, f64) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn scroll_trampoline<F: Fn(&EventControllerScroll, f64, f64) + 'static>(this: *mut ffi::GtkEventControllerScroll, dx: libc::c_double, dy: libc::c_double, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
    ...
    pub fn connect_scroll_begin<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn scroll_begin_trampoline<F: Fn(&EventControllerScroll) + 'static>(this: *mut ffi::GtkEventControllerScroll, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"scroll-begin\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(scroll_begin_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "scroll-end")]
    pub fn connect_scroll_end<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn scroll_end_trampoline<F: Fn(&EventControllerScroll) + 'static>(this: *mut ffi::GtkEventControllerScroll, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"scroll-end\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(scroll_end_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    pub fn connect_flags_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_flags_trampoline<F: Fn(&EventControllerScroll) + 'static>(this: *mut ffi::GtkEventControllerScroll, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(&from_glib_borrow(this))
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::flags\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_flags_trampoline::<F> as *const ())), Box_::into_raw(f))
        }
    }
}
