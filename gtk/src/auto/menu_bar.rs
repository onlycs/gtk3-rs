...
pub struct MenuBarBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("child-pack-direction", child_pack_direction), }
                        }

                            pub fn pack_direction(self, pack_direction: PackDirection) -> Self {
                            Self { builder: self.builder.property("pack-direction", pack_direction), }
                        }
...
pub trait MenuBarExt: IsA<MenuBar> + sealed::Sealed + 'static {
    ...
    fn set_child_pack_direction(&self, child_pack_dir: PackDirection) {
        unsafe {
            ffi::gtk_menu_bar_set_child_pack_direction(self.as_ref().to_glib_none().0, child_pack_dir.into_glib());
        }
    }
    ...
    fn set_pack_direction(&self, pack_dir: PackDirection) {
        unsafe {
            ffi::gtk_menu_bar_set_pack_direction(self.as_ref().to_glib_none().0, pack_dir.into_glib());
        }
    }

    #[doc(alias = "child-pack-direction")]
    fn connect_child_pack_direction_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_child_pack_direction_trampoline<P: IsA<MenuBar>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenuBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::child-pack-direction\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_child_pack_direction_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "pack-direction")]
    fn connect_pack_direction_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pack_direction_trampoline<P: IsA<MenuBar>, F: Fn(&P) + 'static>(this: *mut ffi::GtkMenuBar, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(MenuBar::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::pack-direction\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_pack_direction_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
