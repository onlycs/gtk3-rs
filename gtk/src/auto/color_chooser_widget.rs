...
use crate::{Align,BaselinePosition,Box,Buildable,ColorChooser,Container,Orientable,Orientation,ResizeMode,Widget};
...
pub trait ColorChooserWidgetExt: IsA<ColorChooserWidget> + sealed::Sealed + 'static {
    ...
    fn connect_show_editor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_show_editor_trampoline<P: IsA<ColorChooserWidget>, F: Fn(&P) + 'static>(this: *mut ffi::GtkColorChooserWidget, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
