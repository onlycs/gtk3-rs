...
pub struct AccelLabelBuilder {
        ...
        fn new() -> Self {
            Self { builder: glib::object::Object::builder() }
                            ...
                            Self { builder: self.builder.property("accel-closure", accel_closure.clone()), }
                        }

                            pub fn accel_widget(self, accel_widget: &impl IsA<Widget>) -> Self {
                            Self { builder: self.builder.property("accel-widget", accel_widget.clone().upcast()), }
                        }
...
pub trait AccelLabelExt: IsA<AccelLabel> + sealed::Sealed + 'static {
    ...
    fn accel(&self) -> (u32, gdk::ModifierType) {
        unsafe {
            ...
            ffi::gtk_accel_label_get_accel(self.as_ref().to_glib_none().0, accelerator_key.as_mut_ptr(), accelerator_mods.as_mut_ptr());
    ...
    fn set_accel(&self, accelerator_key: u32, accelerator_mods: gdk::ModifierType) {
        unsafe {
            ffi::gtk_accel_label_set_accel(self.as_ref().to_glib_none().0, accelerator_key, accelerator_mods.into_glib());
        }
    }
    ...
    fn connect_accel_closure_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_closure_trampoline<P: IsA<AccelLabel>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAccelLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-closure\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_accel_closure_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "accel-widget")]
    fn connect_accel_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_accel_widget_trampoline<P: IsA<AccelLabel>, F: Fn(&P) + 'static>(this: *mut ffi::GtkAccelLabel, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(AccelLabel::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::accel-widget\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_accel_widget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
