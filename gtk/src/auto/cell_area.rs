...
use crate::{Buildable,CellAreaContext,CellEditable,CellLayout,CellRenderer,CellRendererState,DirectionType,Orientation,SizeRequestMode,TreeIter,TreeModel,TreePath,Widget};
...
pub trait CellAreaExt: IsA<CellArea> + sealed::Sealed + 'static {
    ...
    fn activate(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, cell_area: &gdk::Rectangle, flags: CellRendererState, edit_only: bool) -> bool {
        unsafe {
            from_glib(ffi::gtk_cell_area_activate(self.as_ref().to_glib_none().0, context.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, cell_area.to_glib_none().0, flags.into_glib(), edit_only.into_glib()))
        }
    }

    #[doc(alias = "gtk_cell_area_activate_cell")]
    fn activate_cell(&self, widget: &impl IsA<Widget>, renderer: &impl IsA<CellRenderer>, event: &gdk::Event, cell_area: &gdk::Rectangle, flags: CellRendererState) -> bool {
        unsafe {
            from_glib(ffi::gtk_cell_area_activate_cell(self.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, renderer.as_ref().to_glib_none().0, mut_override(event.to_glib_none().0), cell_area.to_glib_none().0, flags.into_glib()))
        }
    }
    ...
    fn apply_attributes(&self, tree_model: &impl IsA<TreeModel>, iter: &TreeIter, is_expander: bool, is_expanded: bool) {
        unsafe {
            ffi::gtk_cell_area_apply_attributes(self.as_ref().to_glib_none().0, tree_model.as_ref().to_glib_none().0, mut_override(iter.to_glib_none().0), is_expander.into_glib(), is_expanded.into_glib());
        }
    }
    ...
    fn cell_get_property(&self, renderer: &impl IsA<CellRenderer>, property_name: &str) -> glib::Value {
        unsafe {
            let mut value = glib::Value::uninitialized();
            ffi::gtk_cell_area_cell_get_property(self.as_ref().to_glib_none().0, renderer.as_ref().to_glib_none().0, property_name.to_glib_none().0, value.to_glib_none_mut().0);
            value
        }
    }
    ...
    fn cell_set_property(&self, renderer: &impl IsA<CellRenderer>, property_name: &str, value: &glib::Value) {
        unsafe {
            ffi::gtk_cell_area_cell_set_property(self.as_ref().to_glib_none().0, renderer.as_ref().to_glib_none().0, property_name.to_glib_none().0, value.to_glib_none().0);
        }
    }
    ...
    fn event(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, event: &gdk::Event, cell_area: &gdk::Rectangle, flags: CellRendererState) -> i32 {
        unsafe {
            ffi::gtk_cell_area_event(self.as_ref().to_glib_none().0, context.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, mut_override(event.to_glib_none().0), cell_area.to_glib_none().0, flags.into_glib())
        }
    }
    ...
    fn focus(&self, direction: DirectionType) -> bool {
        unsafe {
            from_glib(ffi::gtk_cell_area_focus(self.as_ref().to_glib_none().0, direction.into_glib()))
        }
    }
    ...
    fn foreach<P: FnMut(&CellRenderer) -> bool>(&self, callback: P) {
        ...
        unsafe extern "C" fn callback_func<P: FnMut(&CellRenderer) -> bool>(renderer: *mut ffi::GtkCellRenderer, data: glib::ffi::gpointer) -> glib::ffi::gboolean {
    ...
    fn foreach_alloc<P: FnMut(&CellRenderer, &gdk::Rectangle, &gdk::Rectangle) -> bool>(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, cell_area: &gdk::Rectangle, background_area: &gdk::Rectangle, callback: P) {
        let callback_data: P = callback;
        unsafe extern "C" fn callback_func<P: FnMut(&CellRenderer, &gdk::Rectangle, &gdk::Rectangle) -> bool>(renderer: *mut ffi::GtkCellRenderer, cell_area: *const gdk::ffi::GdkRectangle, cell_background: *const gdk::ffi::GdkRectangle, data: glib::ffi::gpointer) -> glib::ffi::gboolean {
            let renderer = from_glib_borrow(renderer);
            let cell_area = from_glib_borrow(cell_area);
            let cell_background = from_glib_borrow(cell_background);
            let callback: *mut P = data as *const _ as usize as *mut P;
            (*callback)(&renderer, &cell_area, &cell_background)
            .into_glib()
        }
        let callback = Some(callback_func::<P> as _);
        let super_callback0: &P = &callback_data;
    ...
    fn cell_allocation(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, renderer: &impl IsA<CellRenderer>, cell_area: &gdk::Rectangle) -> gdk::Rectangle {
        unsafe {
    ...
    fn cell_at_position(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, cell_area: &gdk::Rectangle, x: i32, y: i32) -> (CellRenderer, gdk::Rectangle) {
        unsafe {
    ...
    fn preferred_height(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>) -> (i32, i32) {
        unsafe {
            ...
            ffi::gtk_cell_area_get_preferred_height(self.as_ref().to_glib_none().0, context.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, minimum_height.as_mut_ptr(), natural_height.as_mut_ptr());
    ...
    fn preferred_height_for_width(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, width: i32) -> (i32, i32) {
        unsafe {
            let mut minimum_height = std::mem::MaybeUninit::uninit();
            let mut natural_height = std::mem::MaybeUninit::uninit();
            ffi::gtk_cell_area_get_preferred_height_for_width(self.as_ref().to_glib_none().0, context.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, width, minimum_height.as_mut_ptr(), natural_height.as_mut_ptr());
            (minimum_height.assume_init(), natural_height.assume_init())
        }
    }
    ...
    fn preferred_width(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>) -> (i32, i32) {
        unsafe {
            ...
            ffi::gtk_cell_area_get_preferred_width(self.as_ref().to_glib_none().0, context.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, minimum_width.as_mut_ptr(), natural_width.as_mut_ptr());
    ...
    fn preferred_width_for_height(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, height: i32) -> (i32, i32) {
        unsafe {
            let mut minimum_width = std::mem::MaybeUninit::uninit();
            let mut natural_width = std::mem::MaybeUninit::uninit();
            ffi::gtk_cell_area_get_preferred_width_for_height(self.as_ref().to_glib_none().0, context.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, height, minimum_width.as_mut_ptr(), natural_width.as_mut_ptr());
            (minimum_width.assume_init(), natural_width.assume_init())
        }
    }
    ...
    fn inner_cell_area(&self, widget: &impl IsA<Widget>, cell_area: &gdk::Rectangle) -> gdk::Rectangle {
        unsafe {
    ...
    fn render(&self, context: &impl IsA<CellAreaContext>, widget: &impl IsA<Widget>, cr: &cairo::Context, background_area: &gdk::Rectangle, cell_area: &gdk::Rectangle, flags: CellRendererState, paint_focus: bool) {
        unsafe {
            ffi::gtk_cell_area_render(self.as_ref().to_glib_none().0, context.as_ref().to_glib_none().0, widget.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), background_area.to_glib_none().0, cell_area.to_glib_none().0, flags.into_glib(), paint_focus.into_glib());
        }
    }
    ...
    fn request_renderer(&self, renderer: &impl IsA<CellRenderer>, orientation: Orientation, widget: &impl IsA<Widget>, for_size: i32) -> (i32, i32) {
        unsafe {
            ...
            ffi::gtk_cell_area_request_renderer(self.as_ref().to_glib_none().0, renderer.as_ref().to_glib_none().0, orientation.into_glib(), widget.as_ref().to_glib_none().0, for_size, minimum_size.as_mut_ptr(), natural_size.as_mut_ptr());
    ...
    fn connect_add_editable<F: Fn(&Self, &CellRenderer, &CellEditable, &gdk::Rectangle, TreePath) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn add_editable_trampoline<P: IsA<CellArea>, F: Fn(&P, &CellRenderer, &CellEditable, &gdk::Rectangle, TreePath) + 'static>(this: *mut ffi::GtkCellArea, renderer: *mut ffi::GtkCellRenderer, editable: *mut ffi::GtkCellEditable, cell_area: *mut gdk::ffi::GdkRectangle, path: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            let path = from_glib_full(crate::ffi::gtk_tree_path_new_from_string(path));
            f(CellArea::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(renderer), &from_glib_borrow(editable), &from_glib_borrow(cell_area), path)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"add-editable\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(add_editable_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
    ...
    fn connect_apply_attributes<F: Fn(&Self, &TreeModel, &TreeIter, bool, bool) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn apply_attributes_trampoline<P: IsA<CellArea>, F: Fn(&P, &TreeModel, &TreeIter, bool, bool) + 'static>(this: *mut ffi::GtkCellArea, model: *mut ffi::GtkTreeModel, iter: *mut ffi::GtkTreeIter, is_expander: glib::ffi::gboolean, is_expanded: glib::ffi::gboolean, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellArea::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(model), &from_glib_borrow(iter), from_glib(is_expander), from_glib(is_expanded))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"apply-attributes\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(apply_attributes_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "focus-changed")]
    fn connect_focus_changed<F: Fn(&Self, &CellRenderer, TreePath) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn focus_changed_trampoline<P: IsA<CellArea>, F: Fn(&P, &CellRenderer, TreePath) + 'static>(this: *mut ffi::GtkCellArea, renderer: *mut ffi::GtkCellRenderer, path: *mut libc::c_char, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            let path = from_glib_full(crate::ffi::gtk_tree_path_new_from_string(path));
            f(CellArea::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(renderer), path)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"focus-changed\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(focus_changed_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "remove-editable")]
    fn connect_remove_editable<F: Fn(&Self, &CellRenderer, &CellEditable) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn remove_editable_trampoline<P: IsA<CellArea>, F: Fn(&P, &CellRenderer, &CellEditable) + 'static>(this: *mut ffi::GtkCellArea, renderer: *mut ffi::GtkCellRenderer, editable: *mut ffi::GtkCellEditable, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellArea::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(renderer), &from_glib_borrow(editable))
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"remove-editable\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(remove_editable_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "edit-widget")]
    fn connect_edit_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_edit_widget_trampoline<P: IsA<CellArea>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellArea, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::edit-widget\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_edit_widget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "edited-cell")]
    fn connect_edited_cell_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_edited_cell_trampoline<P: IsA<CellArea>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellArea, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellArea::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::edited-cell\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_edited_cell_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "focus-cell")]
    fn connect_focus_cell_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_focus_cell_trampoline<P: IsA<CellArea>, F: Fn(&P) + 'static>(this: *mut ffi::GtkCellArea, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(CellArea::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::focus-cell\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_focus_cell_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}
