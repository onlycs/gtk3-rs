...
use crate::{Align,BaselinePosition,Buildable,Container,Orientable,Orientation,PackType,ResizeMode,Widget};
...
pub trait BoxExt: IsA<Box> + sealed::Sealed + 'static {
    ...
    fn pack_end(&self, child: &impl IsA<Widget>, expand: bool, fill: bool, padding: u32) {
        unsafe {
            ffi::gtk_box_pack_end(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, expand.into_glib(), fill.into_glib(), padding);
        }
    }
    ...
    fn pack_start(&self, child: &impl IsA<Widget>, expand: bool, fill: bool, padding: u32) {
        unsafe {
            ffi::gtk_box_pack_start(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, expand.into_glib(), fill.into_glib(), padding);
        }
    }
    ...
    fn query_child_packing(&self, child: &impl IsA<Widget>) -> (bool, bool, u32, PackType) {
        unsafe {
            ...
            ffi::gtk_box_query_child_packing(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, expand.as_mut_ptr(), fill.as_mut_ptr(), padding.as_mut_ptr(), pack_type.as_mut_ptr());
            (from_glib(expand.assume_init()), from_glib(fill.assume_init()), padding.assume_init(), from_glib(pack_type.assume_init()))
        }
    }
    ...
    fn set_baseline_position(&self, position: BaselinePosition) {
        unsafe {
            ffi::gtk_box_set_baseline_position(self.as_ref().to_glib_none().0, position.into_glib());
        }
    }
    ...
    fn set_child_packing(&self, child: &impl IsA<Widget>, expand: bool, fill: bool, padding: u32, pack_type: PackType) {
        unsafe {
            ffi::gtk_box_set_child_packing(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0, expand.into_glib(), fill.into_glib(), padding, pack_type.into_glib());
        }
    }
    ...
    fn child_fills<T: IsA<crate::Widget>>(&self, item: &T) -> bool {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"fill")
    }

    fn set_child_fill<T: IsA<crate::Widget>>(&self, item: &T, fill: bool) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"fill", &fill)
    }
    ...
    fn child_padding<T: IsA<crate::Widget>>(&self, item: &T) -> u32 {
        crate::prelude::ContainerExtManual::child_property(self.as_ref(), &item.clone().upcast(),"padding")
    }

    fn set_child_padding<T: IsA<crate::Widget>>(&self, item: &T, padding: u32) {
        crate::prelude::ContainerExtManual::child_set_property(self.as_ref(), &item.clone().upcast(),"padding", &padding)
    }
    ...
    fn connect_baseline_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_baseline_position_trampoline<P: IsA<Box>, F: Fn(&P) + 'static>(this: *mut ffi::GtkBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::baseline-position\0".as_ptr() as *const _,
                Some(std::mem::transmute::<_, unsafe extern "C" fn()>(notify_baseline_position_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }

    #[doc(alias = "homogeneous")]
    fn connect_homogeneous_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_homogeneous_trampoline<P: IsA<Box>, F: Fn(&P) + 'static>(this: *mut ffi::GtkBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Box::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
    ...
    fn connect_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_spacing_trampoline<P: IsA<Box>, F: Fn(&P) + 'static>(this: *mut ffi::GtkBox, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) {
            let f: &F = &*(f as *const F);
            f(Box::from_glib_borrow(this).unsafe_cast_ref())
        }
        unsafe {
